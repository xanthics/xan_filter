...
settings = {
	...
	"gem very high": ["SetBorderColor {}".format(color['gem']),
					  ...
					  'CustomAlertSound "{}_gem.wav"'.format(volume['high']),
					  "SetFontSize {}".format(size['vlarge']),
					  "SetBackgroundColor {} 220".format(color['black'])],
	...
	"fragment extremely high": ['MinimapIcon 0 Green Diamond',
								"SetTextColor {}".format(color['premiumlavender']),
								'PlayEffect Green',
								"SetBorderColor {}".format(color['premiumlavender']),
								"SetFontSize {}".format(size['huge']),
								'CustomAlertSound "{}_valuable.wav"'.format(volume['max']),
								"SetBackgroundColor {} 220".format(color['highlight'])],
	"fragment very high": ['MinimapIcon 1 Blue Diamond',
						   "SetTextColor {}".format(color['premiumlavender']),
						   'PlayEffect Blue',
						   "SetBorderColor {}".format(color['premiumlavender']),
						   "SetFontSize {}".format(size['vlarge']),
						   ...
						   "SetBackgroundColor {} 220".format(color['black'])],
	"fragment high": ['MinimapIcon 1 Blue Diamond',
					  "SetTextColor {}".format(color['premiumlavender']),
					  "SetFontSize {}".format(size['normal']),
					  "SetBorderColor {}".format(color['premiumlavender']),
					  'CustomAlertSound "{}_map_good.wav"'.format(volume['normal']),
					  "SetBackgroundColor {} 220".format(color['black'])],
	"fragment normal": ["SetFontSize {}".format(size['normal']),
						"SetTextColor {}".format(color['premiumlavender']),
						"SetBorderColor {} 150".format(color['premiumlavender']),
						'MinimapIcon 2 Brown Diamond',
						"SetBackgroundColor {} 220".format(color['black'])],
	"fragment low": ["SetFontSize {}".format(size['small']),
					 "SetTextColor {}".format(color['premiumlavender']),
					 "SetBorderColor {} 100".format(color['premiumlavender']),
					 "SetBackgroundColor {} 220".format(color['black'])],
	...
	"map very good": ["SetBorderColor {}".format(color['fire']),
					 ...
					 'PlayEffect Red',
					 "SetFontSize {}".format(size['huge']),
					 'CustomAlertSound "{}_map_good.wav"'.format(volume['max']),
					 "SetBackgroundColor {} 220".format(color['black'])],
