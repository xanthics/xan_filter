...
items = {
	...
	"001 The Price of Loyalty": {"base": "The Price of Loyalty", "class": "Divination Card", "type": "divination normal"},
	"002 The Dragon's Heart": {"base": "The Dragon's Heart", "class": "Divination Card", "type": "divination very high"},
	"003 The Master Artisan": {"base": "The Master Artisan", "class": "Divination Card", "type": "divination normal"},
	"004 The Wolf's Shadow": {"base": "The Wolf's Shadow", "class": "Divination Card", "type": "divination low"},
	"005 The Wolf's Legacy": {"base": "The Wolf's Legacy", "class": "Divination Card", "type": "divination normal"},
	"006 Glimmer of Hope": {"base": "Glimmer of Hope", "class": "Divination Card", "type": "divination normal"},
	"007 The Demoness": {"base": "The Demoness", "class": "Divination Card", "type": "divination low"},
	"008 Last Hope": {"base": "Last Hope", "class": "Divination Card", "type": "divination normal"},
	...
	"1 Akil's Prophecy": {"base": "Akil's Prophecy", "class": "Divination Card", "type": "divination very high"},
	"1 Alluring Bounty": {"base": "Alluring Bounty", "class": "Divination Card", "type": "divination extremely high"},
	...
	"1 More is Never Enough": {"base": "More is Never Enough", "class": "Divination Card", "type": "divination high"},
	...
	"1 The Bargain": {"base": "The Bargain", "class": "Divination Card", "type": "divination high"},
	...
	"1 The Damned": {"base": "The Damned", "class": "Divination Card", "type": "divination very high"},
	"1 The Deal": {"base": "The Deal", "class": "Divination Card", "type": "divination high"},
	"1 The Demon": {"base": "The Demon", "class": "Divination Card", "type": "divination very high"},
	...
	"1 The Eye of Terror": {"base": "The Eye of Terror", "class": "Divination Card", "type": "divination high"},
	"1 The Fathomless Depths": {"base": "The Fathomless Depths", "class": "Divination Card", "type": "divination low"},
	...
	"1 The Lover": {"base": "The Lover", "class": "Divination Card", "type": "hide"},
	...
	"1 The Nurse": {"base": "The Nurse", "class": "Divination Card", "type": "divination extremely high"},
	"1 The Oath": {"base": "The Oath", "class": "Divination Card", "type": "divination low"},
	"1 The Old Man": {"base": "The Old Man", "class": "Divination Card", "type": "divination high"},
	"1 The Opulent": {"base": "The Opulent", "class": "Divination Card", "type": "hide"},
	...
	"1 The Poet": {"base": "The Poet", "class": "Divination Card", "type": "divination low"},
	...
	"1 The Skeleton": {"base": "The Skeleton", "class": "Divination Card", "type": "divination low"},
	...
	"1 The Sun": {"base": "The Sun", "class": "Divination Card", "type": "divination low"},
	...
	"1 Void of the Elements": {"base": "Void of the Elements", "class": "Divination Card", "type": "divination high"},
