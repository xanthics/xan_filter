...
items = {
	...
	"09 Eternal Orb": {"base": "Eternal Orb", 'other': ['StackSize >= 12'], "class": "Currency", "type": "currency very high"},
	...
	"08 Regal Orb": {"base": "Regal Orb", 'other': ['StackSize >= 18'], "class": "Currency", "type": "currency very high"},
