...
items = {
	...
	"09 Binding Shard": {"base": "Binding Shard", 'other': ['StackSize >= 17'], "class": "Currency", "type": "currency normal"},
	...
	"07 Splinter of Tul": {"base": "Splinter of Tul", 'other': ['StackSize >= 94'], "class": "Currency", "type": "currency very high"},
