...
items = {
	...
	"09 Alchemy Shard": {"base": "Alchemy Shard", 'other': ['StackSize >= 7'], "class": "Currency", "type": "currency low"},
	...
	"09 Apprentice Cartographer's Sextant": {"base": "Apprentice Cartographer's Sextant", 'other': ['StackSize >= 4'], "class": "Currency", "type": "currency very high"},
	"1 Armourer's Scrap": {"base": "Armourer's Scrap", "class": "Currency", "type": "currency normal"},
	"09 Armourer's Scrap": {"base": "Armourer's Scrap", 'other': ['StackSize >= 4'], "class": "Currency", "type": "currency high"},
	"08 Armourer's Scrap": {"base": "Armourer's Scrap", 'other': ['StackSize >= 16'], "class": "Currency", "type": "currency very high"},
	...
	"09 Blacksmith's Whetstone": {"base": "Blacksmith's Whetstone", 'other': ['StackSize >= 2'], "class": "Currency", "type": "currency high"},
	"08 Blacksmith's Whetstone": {"base": "Blacksmith's Whetstone", 'other': ['StackSize >= 10'], "class": "Currency", "type": "currency very high"},
	"1 Blessed Orb": {"base": "Blessed Orb", "class": "Currency", "type": "currency high"},
	"09 Blessed Orb": {"base": "Blessed Orb", 'other': ['StackSize >= 5'], "class": "Currency", "type": "currency very high"},
	...
	"1 Cartographer's Chisel": {"base": "Cartographer's Chisel", "class": "Currency", "type": "currency high"},
	"09 Cartographer's Chisel": {"base": "Cartographer's Chisel", 'other': ['StackSize >= 5'], "class": "Currency", "type": "currency very high"},
	"1 Chromatic Orb": {"base": "Chromatic Orb", "class": "Currency", "type": "currency show"},
	"09 Chromatic Orb": {"base": "Chromatic Orb", 'other': ['StackSize >= 7'], "class": "Currency", "type": "currency normal"},
	...
	"08 Divine Orb": {"base": "Divine Orb", 'other': ['StackSize >= 13'], "class": "Currency", "type": "currency extremely high"},
	...
	"09 Exalted Orb": {"base": "Exalted Orb", 'other': ['StackSize >= 3'], "class": "Currency", "type": "currency extremely high"},
	...
	"1 Glassblower's Bauble": {"base": "Glassblower's Bauble", "class": "Currency", "type": "currency high"},
	"09 Glassblower's Bauble": {"base": "Glassblower's Bauble", 'other': ['StackSize >= 5'], "class": "Currency", "type": "currency very high"},
	...
	"08 Harbinger's Shard": {"base": "Harbinger's Shard", 'other': ['StackSize >= 7'], "class": "Currency", "type": "currency high"},
	...
	"08 Jeweller's Orb": {"base": "Jeweller's Orb", 'other': ['StackSize >= 9'], "class": "Currency", "type": "currency high"},
	"1 Journeyman Cartographer's Sextant": {"base": "Journeyman Cartographer's Sextant", "class": "Currency", "type": "currency high"},
	"09 Journeyman Cartographer's Sextant": {"base": "Journeyman Cartographer's Sextant", 'other': ['StackSize >= 2'], "class": "Currency", "type": "currency very high"},
	"08 Journeyman Cartographer's Sextant": {"base": "Journeyman Cartographer's Sextant", 'other': ['StackSize >= 18'], "class": "Currency", "type": "currency extremely high"},
	...
	"08 Master Cartographer's Sextant": {"base": "Master Cartographer's Sextant", 'other': ['StackSize >= 13'], "class": "Currency", "type": "currency extremely high"},
	...
	"1 Orb of Alchemy": {"base": "Orb of Alchemy", "class": "Currency", "type": "currency low"},
	"09 Orb of Alchemy": {"base": "Orb of Alchemy", 'other': ['StackSize >= 2'], "class": "Currency", "type": "currency normal"},
	"08 Orb of Alchemy": {"base": "Orb of Alchemy", 'other': ['StackSize >= 5'], "class": "Currency", "type": "currency high"},
	"1 Orb of Alteration": {"base": "Orb of Alteration", "class": "Currency", "type": "currency very low"},
	"09 Orb of Alteration": {"base": "Orb of Alteration", 'other': ['StackSize >= 3'], "class": "Currency", "type": "currency low"},
	"08 Orb of Alteration": {"base": "Orb of Alteration", 'other': ['StackSize >= 9'], "class": "Currency", "type": "currency normal"},
	...
	"08 Orb of Annulment": {"base": "Orb of Annulment", 'other': ['StackSize >= 17'], "class": "Currency", "type": "currency extremely high"},
	"1 Orb of Augmentation": {"base": "Orb of Augmentation", "class": "Currency", "type": "currency low"},
	"09 Orb of Augmentation": {"base": "Orb of Augmentation", 'other': ['StackSize >= 2'], "class": "Currency", "type": "currency normal"},
	"08 Orb of Augmentation": {"base": "Orb of Augmentation", 'other': ['StackSize >= 5'], "class": "Currency", "type": "currency high"},
	...
	"08 Orb of Chance": {"base": "Orb of Chance", 'other': ['StackSize >= 16'], "class": "Currency", "type": "currency very high"},
	...
	"09 Orb of Horizons": {"base": "Orb of Horizons", 'other': ['StackSize >= 5'], "class": "Currency", "type": "currency very high"},
	"1 Orb of Regret": {"base": "Orb of Regret", "class": "Currency", "type": "currency high"},
	"09 Orb of Regret": {"base": "Orb of Regret", 'other': ['StackSize >= 5'], "class": "Currency", "type": "currency very high"},
	...
	"08 Orb of Scouring": {"base": "Orb of Scouring", 'other': ['StackSize >= 10'], "class": "Currency", "type": "currency very high"},
	"1 Orb of Transmutation": {"base": "Orb of Transmutation", "class": "Currency", "type": "currency normal"},
	"09 Orb of Transmutation": {"base": "Orb of Transmutation", 'other': ['StackSize >= 2'], "class": "Currency", "type": "currency high"},
	"08 Orb of Transmutation": {"base": "Orb of Transmutation", 'other': ['StackSize >= 10'], "class": "Currency", "type": "currency very high"},
	...
	"09 Portal Scroll": {"base": "Portal Scroll", 'other': ['StackSize >= 2'], "class": "Currency", "type": "currency low"},
	"08 Portal Scroll": {"base": "Portal Scroll", 'other': ['StackSize >= 5'], "class": "Currency", "type": "currency normal"},
	"07 Portal Scroll": {"base": "Portal Scroll", 'other': ['StackSize >= 20'], "class": "Currency", "type": "currency high"},
	...
	"1 Prime Alchemical Resonator": {"base": "Prime Alchemical Resonator", "class": "Currency", "type": "currency extremely high"},
	"1 Prime Chaotic Resonator": {"base": "Prime Chaotic Resonator", "class": "Currency", "type": "currency extremely high"},
	...
	"09 Scroll Fragment": {"base": "Scroll Fragment", 'other': ['StackSize >= 3'], "class": "Currency", "type": "currency low"},
	"08 Scroll Fragment": {"base": "Scroll Fragment", 'other': ['StackSize >= 10'], "class": "Currency", "type": "currency normal"},
	"1 Scroll of Wisdom": {"base": "Scroll of Wisdom", "class": "Currency", "type": "currency normal"},
	"09 Scroll of Wisdom": {"base": "Scroll of Wisdom", 'other': ['StackSize >= 2'], "class": "Currency", "type": "currency high"},
	"08 Scroll of Wisdom": {"base": "Scroll of Wisdom", 'other': ['StackSize >= 10'], "class": "Currency", "type": "currency very high"},
	...
	"08 Silver Coin": {"base": "Silver Coin", 'other': ['StackSize >= 20'], "class": "Currency", "type": "currency very high"},
	"1 Splinter of Chayula": {"base": "Splinter of Chayula", "class": "Currency", "type": "currency high"},
	"09 Splinter of Chayula": {"base": "Splinter of Chayula", 'other': ['StackSize >= 4'], "class": "Currency", "type": "currency very high"},
	...
	"09 Transmutation Shard": {"base": "Transmutation Shard", 'other': ['StackSize >= 3'], "class": "Currency", "type": "currency low"},
	"08 Transmutation Shard": {"base": "Transmutation Shard", 'other': ['StackSize >= 10'], "class": "Currency", "type": "currency normal"},
	"1 Vaal Orb": {"base": "Vaal Orb", "class": "Currency", "type": "currency high"},
	"09 Vaal Orb": {"base": "Vaal Orb", 'other': ['StackSize >= 5'], "class": "Currency", "type": "currency very high"},
}
