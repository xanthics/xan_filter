...
items = {
	...
	"09 Ancient Orb": {"base": "Ancient Orb", 'other': ['StackSize >= 6'], "class": "Currency", "type": "currency extremely high"},
	"1 Ancient Shard": {"base": "Ancient Shard", "class": "Currency", "type": "currency high"},
	"09 Ancient Shard": {"base": "Ancient Shard", 'other': ['StackSize >= 11'], "class": "Currency", "type": "currency very high"},
	...
	"08 Annulment Shard": {"base": "Annulment Shard", 'other': ['StackSize >= 19'], "class": "Currency", "type": "currency very high"},
	...
	"09 Binding Shard": {"base": "Binding Shard", 'other': ['StackSize >= 7'], "class": "Currency", "type": "currency low"},
	...
	"09 Engineer's Shard": {"base": "Engineer's Shard", 'other': ['StackSize >= 4'], "class": "Currency", "type": "currency low"},
	...
	"09 Horizon Shard": {"base": "Horizon Shard", 'other': ['StackSize >= 4'], "class": "Currency", "type": "currency low"},
	...
	"09 Orb of Augmentation": {"base": "Orb of Augmentation", 'other': ['StackSize >= 9'], "class": "Currency", "type": "currency normal"},
	...
	"09 Orb of Transmutation": {"base": "Orb of Transmutation", 'other': ['StackSize >= 7'], "class": "Currency", "type": "currency normal"},
	"08 Orb of Transmutation": {"base": "Orb of Transmutation", 'other': ['StackSize >= 25'], "class": "Currency", "type": "currency high"},
	...
	"07 Perandus Coin": {"base": "Perandus Coin", 'other': ['StackSize >= 750'], "class": "Currency", "type": "currency very high"},
	...
	"07 Portal Scroll": {"base": "Portal Scroll", 'other': ['StackSize >= 34'], "class": "Currency", "type": "currency high"},
	...
	"09 Regal Shard": {"base": "Regal Shard", 'other': ['StackSize >= 4'], "class": "Currency", "type": "currency low"},
	...
	"08 Splinter of Chayula": {"base": "Splinter of Chayula", 'other': ['StackSize >= 81'], "class": "Currency", "type": "currency extremely high"},
	...
	"08 Splinter of Esh": {"base": "Splinter of Esh", 'other': ['StackSize >= 8'], "class": "Currency", "type": "currency high"},
	...
	"08 Splinter of Tul": {"base": "Splinter of Tul", 'other': ['StackSize >= 56'], "class": "Currency", "type": "currency very high"},
	...
	"08 Splinter of Uul-Netol": {"base": "Splinter of Uul-Netol", 'other': ['StackSize >= 54'], "class": "Currency", "type": "currency very high"},
	...
	"08 Splinter of Xoph": {"base": "Splinter of Xoph", 'other': ['StackSize >= 6'], "class": "Currency", "type": "currency high"},
	"07 Splinter of Xoph": {"base": "Splinter of Xoph", 'other': ['StackSize >= 89'], "class": "Currency", "type": "currency very high"},
	...
	"1 Vial of Awakening": {"base": "Vial of Awakening", "class": "Currency", "type": "currency very high"},
	"1 Vial of Consequence": {"base": "Vial of Consequence", "class": "Currency", "type": "currency very high"},
	...
	"1 Vial of Sacrifice": {"base": "Vial of Sacrifice", "class": "Currency", "type": "currency very high"},
	"1 Vial of Summoning": {"base": "Vial of Summoning", "class": "Currency", "type": "currency very high"},
	"1 Vial of Transcendence": {"base": "Vial of Transcendence", "class": "Currency", "type": "currency very high"},
