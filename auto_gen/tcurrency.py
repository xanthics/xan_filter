...
items = {
	...
	"09 Ancient Shard": {"base": "Ancient Shard", 'other': ['StackSize >= 7'], "class": "Currency", "type": "currency very high"},
	...
	"08 Apprentice Cartographer's Sextant": {"base": "Apprentice Cartographer's Sextant", 'other': ['StackSize >= 17'], "class": "Currency", "type": "currency very high"},
	...
	"07 Binding Shard": {"base": "Binding Shard", 'other': ['StackSize >= 16'], "class": "Currency", "type": "currency normal"},
	...
	"09 Chaos Orb": {"base": "Chaos Orb", 'other': ['StackSize >= 15'], "class": "Currency", "type": "currency very high"},
	...
	"1 Engineer's Orb": {"base": "Engineer's Orb", "class": "Currency", "type": "currency low"},
	"09 Engineer's Orb": {"base": "Engineer's Orb", 'other': ['StackSize >= 2'], "class": "Currency", "type": "currency normal"},
	"08 Engineer's Orb": {"base": "Engineer's Orb", 'other': ['StackSize >= 6'], "class": "Currency", "type": "currency high"},
	"1 Engineer's Shard": {"base": "Engineer's Shard", "class": "Currency", "type": "hide"},
	"09 Engineer's Shard": {"base": "Engineer's Shard", 'other': ['StackSize >= 7'], "class": "Currency", "type": "currency very low"},
	"08 Engineer's Shard": {"base": "Engineer's Shard", 'other': ['StackSize >= 14'], "class": "Currency", "type": "currency low"},
	...
	"08 Glassblower's Bauble": {"base": "Glassblower's Bauble", 'other': ['StackSize >= 10'], "class": "Currency", "type": "currency high"},
	...
	"09 Harbinger's Orb": {"base": "Harbinger's Orb", 'other': ['StackSize >= 9'], "class": "Currency", "type": "currency extremely high"},
	...
	"08 Harbinger's Shard": {"base": "Harbinger's Shard", 'other': ['StackSize >= 18'], "class": "Currency", "type": "currency very high"},
	...
	"09 Horizon Shard": {"base": "Horizon Shard", 'other': ['StackSize >= 6'], "class": "Currency", "type": "currency normal"},
	...
	"08 Jeweller's Orb": {"base": "Jeweller's Orb", 'other': ['StackSize >= 4'], "class": "Currency", "type": "currency normal"},
	"07 Jeweller's Orb": {"base": "Jeweller's Orb", 'other': ['StackSize >= 13'], "class": "Currency", "type": "currency high"},
	"1 Journeyman Cartographer's Sextant": {"base": "Journeyman Cartographer's Sextant", "class": "Currency", "type": "currency high"},
	"09 Journeyman Cartographer's Sextant": {"base": "Journeyman Cartographer's Sextant", 'other': ['StackSize >= 8'], "class": "Currency", "type": "currency very high"},
	...
	"09 Master Cartographer's Sextant": {"base": "Master Cartographer's Sextant", 'other': ['StackSize >= 6'], "class": "Currency", "type": "currency very high"},
	...
	"09 Orb of Annulment": {"base": "Orb of Annulment", 'other': ['StackSize >= 3'], "class": "Currency", "type": "currency extremely high"},
	...
	"08 Orb of Horizons": {"base": "Orb of Horizons", 'other': ['StackSize >= 16'], "class": "Currency", "type": "currency very high"},
	...
	"09 Portal Scroll": {"base": "Portal Scroll", 'other': ['StackSize >= 7'], "class": "Currency", "type": "currency very low"},
	"08 Portal Scroll": {"base": "Portal Scroll", 'other': ['StackSize >= 13'], "class": "Currency", "type": "currency low"},
	...
	"08 Regal Orb": {"base": "Regal Orb", 'other': ['StackSize >= 16'], "class": "Currency", "type": "currency very high"},
	...
	"08 Splinter of Xoph": {"base": "Splinter of Xoph", 'other': ['StackSize >= 9'], "class": "Currency", "type": "currency high"},
	...
	"09 Vaal Orb": {"base": "Vaal Orb", 'other': ['StackSize >= 12'], "class": "Currency", "type": "currency very high"},
