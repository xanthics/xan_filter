...
items = {
	...
	"09 Ancient Orb": {"base": "Ancient Orb", 'other': ['StackSize >= 10'], "class": "Currency", "type": "currency extremely high"},
	...
	"08 Ancient Shard": {"base": "Ancient Shard", 'other': ['StackSize >= 19'], "class": "Currency", "type": "currency very high"},
	...
	"09 Blessed Orb": {"base": "Blessed Orb", 'other': ['StackSize >= 2'], "class": "Currency", "type": "currency very low"},
	"08 Blessed Orb": {"base": "Blessed Orb", 'other': ['StackSize >= 4'], "class": "Currency", "type": "currency low"},
	"07 Blessed Orb": {"base": "Blessed Orb", 'other': ['StackSize >= 7'], "class": "Currency", "type": "currency normal"},
	...
	"09 Engineer's Orb": {"base": "Engineer's Orb", 'other': ['StackSize >= 13'], "class": "Currency", "type": "currency very high"},
	...
	"08 Engineer's Shard": {"base": "Engineer's Shard", 'other': ['StackSize >= 16'], "class": "Currency", "type": "currency high"},
	...
	"09 Horizon Shard": {"base": "Horizon Shard", 'other': ['StackSize >= 14'], "class": "Currency", "type": "currency normal"},
	...
	"07 Jeweller's Orb": {"base": "Jeweller's Orb", 'other': ['StackSize >= 9'], "class": "Currency", "type": "currency high"},
	...
	"07 Orb of Chance": {"base": "Orb of Chance", 'other': ['StackSize >= 13'], "class": "Currency", "type": "currency high"},
	...
	"09 Regal Shard": {"base": "Regal Shard", 'other': ['StackSize >= 19'], "class": "Currency", "type": "currency normal"},
	...
	"08 Splinter of Uul-Netol": {"base": "Splinter of Uul-Netol", 'other': ['StackSize >= 9'], "class": "Currency", "type": "currency high"},
