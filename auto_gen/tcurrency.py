...
items = {
	...
	"09 Alchemy Shard": {"base": "Alchemy Shard", 'other': ['StackSize >= 17'], "class": "Currency", "type": "currency normal"},
	...
	"08 Annulment Shard": {"base": "Annulment Shard", 'other': ['StackSize >= 9'], "class": "Currency", "type": "currency very high"},
	...
	"09 Binding Shard": {"base": "Binding Shard", 'other': ['StackSize >= 5'], "class": "Currency", "type": "currency normal"},
	"08 Binding Shard": {"base": "Binding Shard", 'other': ['StackSize >= 20'], "class": "Currency", "type": "currency high"},
	...
	"07 Blacksmith's Whetstone": {"base": "Blacksmith's Whetstone", 'other': ['StackSize >= 10'], "class": "Currency", "type": "currency high"},
	...
	"09 Engineer's Shard": {"base": "Engineer's Shard", 'other': ['StackSize >= 9'], "class": "Currency", "type": "currency normal"},
	...
	"09 Orb of Augmentation": {"base": "Orb of Augmentation", 'other': ['StackSize >= 7'], "class": "Currency", "type": "currency normal"},
	"1 Orb of Binding": {"base": "Orb of Binding", "class": "Currency", "type": "currency high"},
	"09 Orb of Binding": {"base": "Orb of Binding", 'other': ['StackSize >= 7'], "class": "Currency", "type": "currency very high"},
	...
	"08 Orb of Regret": {"base": "Orb of Regret", 'other': ['StackSize >= 11'], "class": "Currency", "type": "currency very high"},
	...
	"08 Portal Scroll": {"base": "Portal Scroll", 'other': ['StackSize >= 7'], "class": "Currency", "type": "currency normal"},
	...
	"08 Regal Orb": {"base": "Regal Orb", 'other': ['StackSize >= 20'], "class": "Currency", "type": "currency very high"},
	"1 Regal Shard": {"base": "Regal Shard", "class": "Currency", "type": "currency show"},
	"09 Regal Shard": {"base": "Regal Shard", 'other': ['StackSize >= 14'], "class": "Currency", "type": "currency normal"},
	...
	"09 Splinter of Chayula": {"base": "Splinter of Chayula", 'other': ['StackSize >= 3'], "class": "Currency", "type": "currency high"},
	"08 Splinter of Chayula": {"base": "Splinter of Chayula", 'other': ['StackSize >= 17'], "class": "Currency", "type": "currency very high"},
	"1 Splinter of Esh": {"base": "Splinter of Esh", "class": "Currency", "type": "currency normal"},
	"09 Splinter of Esh": {"base": "Splinter of Esh", 'other': ['StackSize >= 2'], "class": "Currency", "type": "currency high"},
	"08 Splinter of Esh": {"base": "Splinter of Esh", 'other': ['StackSize >= 14'], "class": "Currency", "type": "currency very high"},
	...
	"08 Vaal Orb": {"base": "Vaal Orb", 'other': ['StackSize >= 16'], "class": "Currency", "type": "currency very high"},
