...
items = {
	...
	"08 Apprentice Cartographer's Sextant": {"base": "Apprentice Cartographer's Sextant", 'other': ['StackSize >= 16'], "class": "Currency", "type": "currency very high"},
	...
	"08 Blessed Orb": {"base": "Blessed Orb", 'other': ['StackSize >= 6'], "class": "Currency", "type": "currency high"},
	...
	"09 Chaos Orb": {"base": "Chaos Orb", 'other': ['StackSize >= 13'], "class": "Currency", "type": "currency very high"},
	...
	"09 Journeyman Cartographer's Sextant": {"base": "Journeyman Cartographer's Sextant", 'other': ['StackSize >= 7'], "class": "Currency", "type": "currency very high"},
	...
	"08 Orb of Augmentation": {"base": "Orb of Augmentation", 'other': ['StackSize >= 12'], "class": "Currency", "type": "currency high"},
	"1 Orb of Binding": {"base": "Orb of Binding", "class": "Currency", "type": "currency show"},
	"09 Orb of Binding": {"base": "Orb of Binding", 'other': ['StackSize >= 2'], "class": "Currency", "type": "currency normal"},
	"08 Orb of Binding": {"base": "Orb of Binding", 'other': ['StackSize >= 5'], "class": "Currency", "type": "currency high"},
	...
	"09 Orb of Transmutation": {"base": "Orb of Transmutation", 'other': ['StackSize >= 13'], "class": "Currency", "type": "currency normal"},
	"1 Perandus Coin": {"base": "Perandus Coin", "class": "Currency", "type": "currency show"},
	"09 Perandus Coin": {"base": "Perandus Coin", 'other': ['StackSize >= 7'], "class": "Currency", "type": "currency normal"},
	...
	"09 Portal Scroll": {"base": "Portal Scroll", 'other': ['StackSize >= 7'], "class": "Currency", "type": "currency low"},
	...
	"09 Regal Orb": {"base": "Regal Orb", 'other': ['StackSize >= 12'], "class": "Currency", "type": "currency very high"},
	...
	"08 Regal Shard": {"base": "Regal Shard", 'other': ['StackSize >= 17'], "class": "Currency", "type": "currency high"},
