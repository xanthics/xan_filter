...
items = {
	...
	"09 Alteration Shard": {"base": "Alteration Shard", 'other': ['StackSize >= 10'], "class": "Currency", "type": "currency low"},
	...
	"09 Chaos Orb": {"base": "Chaos Orb", 'other': ['StackSize >= 16'], "class": "Currency", "type": "currency very high"},
	...
	"09 Divine Orb": {"base": "Divine Orb", 'other': ['StackSize >= 11'], "class": "Currency", "type": "currency extremely high"},
	...
	"08 Engineer's Orb": {"base": "Engineer's Orb", 'other': ['StackSize >= 19'], "class": "Currency", "type": "currency very high"},
	...
	"09 Orb of Chance": {"base": "Orb of Chance", 'other': ['StackSize >= 5'], "class": "Currency", "type": "currency normal"},
	"08 Orb of Chance": {"base": "Orb of Chance", 'other': ['StackSize >= 17'], "class": "Currency", "type": "currency high"},
	...
	"09 Regal Orb": {"base": "Regal Orb", 'other': ['StackSize >= 14'], "class": "Currency", "type": "currency very high"},
	...
	"09 Vaal Orb": {"base": "Vaal Orb", 'other': ['StackSize >= 13'], "class": "Currency", "type": "currency very high"},
