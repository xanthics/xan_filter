...
items = {
	...
	"07 Alchemy Shard": {"base": "Alchemy Shard", 'other': ['StackSize >= 10'], "class": "Currency", "type": "currency normal"},
	...
	"09 Ancient Shard": {"base": "Ancient Shard", 'other': ['StackSize >= 10'], "class": "Currency", "type": "currency very high"},
	"1 Annulment Shard": {"base": "Annulment Shard", "class": "Currency", "type": "currency high"},
	"09 Annulment Shard": {"base": "Annulment Shard", 'other': ['StackSize >= 9'], "class": "Currency", "type": "currency very high"},
	...
	"07 Binding Shard": {"base": "Binding Shard", 'other': ['StackSize >= 12'], "class": "Currency", "type": "currency normal"},
	...
	"07 Engineer's Shard": {"base": "Engineer's Shard", 'other': ['StackSize >= 9'], "class": "Currency", "type": "currency normal"},
	...
	"08 Perandus Coin": {"base": "Perandus Coin", 'other': ['StackSize >= 13'], "class": "Currency", "type": "currency high"},
