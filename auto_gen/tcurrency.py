...
items = {
	...
	"08 Ancient Orb": {"base": "Ancient Orb", 'other': ['StackSize >= 16'], "class": "Currency", "type": "currency extremely high"},
	...
	"08 Blacksmith's Whetstone": {"base": "Blacksmith's Whetstone", 'other': ['StackSize >= 4'], "class": "Currency", "type": "currency normal"},
	"07 Blacksmith's Whetstone": {"base": "Blacksmith's Whetstone", 'other': ['StackSize >= 15'], "class": "Currency", "type": "currency high"},
	...
	"09 Engineer's Orb": {"base": "Engineer's Orb", 'other': ['StackSize >= 10'], "class": "Currency", "type": "currency very high"},
	...
	"08 Harbinger's Orb": {"base": "Harbinger's Orb", 'other': ['StackSize >= 14'], "class": "Currency", "type": "currency extremely high"},
	...
	"09 Horizon Shard": {"base": "Horizon Shard", 'other': ['StackSize >= 8'], "class": "Currency", "type": "currency normal"},
	...
	"08 Orb of Alteration": {"base": "Orb of Alteration", 'other': ['StackSize >= 8'], "class": "Currency", "type": "currency high"},
	...
	"08 Orb of Annulment": {"base": "Orb of Annulment", 'other': ['StackSize >= 12'], "class": "Currency", "type": "currency extremely high"},
	...
	"07 Perandus Coin": {"base": "Perandus Coin", 'other': ['StackSize >= 500'], "class": "Currency", "type": "currency very high"},
	...
	"09 Regal Shard": {"base": "Regal Shard", 'other': ['StackSize >= 16'], "class": "Currency", "type": "currency normal"},
	...
	"07 Splinter of Tul": {"base": "Splinter of Tul", 'other': ['StackSize >= 89'], "class": "Currency", "type": "currency very high"},
	...
	"07 Splinter of Uul-Netol": {"base": "Splinter of Uul-Netol", 'other': ['StackSize >= 94'], "class": "Currency", "type": "currency very high"},
	...
	"1 Timeless Eternal Empire Splinter": {"base": "Timeless Eternal Empire Splinter", "class": "Currency", "type": "currency show"},
	"09 Timeless Eternal Empire Splinter": {"base": "Timeless Eternal Empire Splinter", 'other': ['StackSize >= 2'], "class": "Currency", "type": "currency normal"},
	"08 Timeless Eternal Empire Splinter": {"base": "Timeless Eternal Empire Splinter", 'other': ['StackSize >= 6'], "class": "Currency", "type": "currency high"},
	"07 Timeless Eternal Empire Splinter": {"base": "Timeless Eternal Empire Splinter", 'other': ['StackSize >= 89'], "class": "Currency", "type": "currency very high"},
	"1 Timeless Karui Splinter": {"base": "Timeless Karui Splinter", "class": "Currency", "type": "currency show"},
	"09 Timeless Karui Splinter": {"base": "Timeless Karui Splinter", 'other': ['StackSize >= 3'], "class": "Currency", "type": "currency normal"},
	"08 Timeless Karui Splinter": {"base": "Timeless Karui Splinter", 'other': ['StackSize >= 9'], "class": "Currency", "type": "currency high"},
	"1 Timeless Maraketh Splinter": {"base": "Timeless Maraketh Splinter", "class": "Currency", "type": "currency high"},
	"09 Timeless Maraketh Splinter": {"base": "Timeless Maraketh Splinter", 'other': ['StackSize >= 11'], "class": "Currency", "type": "currency very high"},
	"1 Timeless Templar Splinter": {"base": "Timeless Templar Splinter", "class": "Currency", "type": "currency normal"},
	"09 Timeless Templar Splinter": {"base": "Timeless Templar Splinter", 'other': ['StackSize >= 2'], "class": "Currency", "type": "currency high"},
	"08 Timeless Templar Splinter": {"base": "Timeless Templar Splinter", 'other': ['StackSize >= 23'], "class": "Currency", "type": "currency very high"},
	"1 Timeless Vaal Splinter": {"base": "Timeless Vaal Splinter", "class": "Currency", "type": "currency show"},
	"09 Timeless Vaal Splinter": {"base": "Timeless Vaal Splinter", 'other': ['StackSize >= 2'], "class": "Currency", "type": "currency normal"},
	"08 Timeless Vaal Splinter": {"base": "Timeless Vaal Splinter", 'other': ['StackSize >= 5'], "class": "Currency", "type": "currency high"},
	"07 Timeless Vaal Splinter": {"base": "Timeless Vaal Splinter", 'other': ['StackSize >= 75'], "class": "Currency", "type": "currency very high"},
