...
items = {
	...
	"09 Alchemy Shard": {"base": "Alchemy Shard", 'other': ['StackSize >= 11'], "class": "Currency", "type": "currency normal"},
	...
	"08 Portal Scroll": {"base": "Portal Scroll", 'other': ['StackSize >= 3'], "class": "Currency", "type": "currency low"},
	"07 Portal Scroll": {"base": "Portal Scroll", 'other': ['StackSize >= 5'], "class": "Currency", "type": "currency normal"},
	"06 Portal Scroll": {"base": "Portal Scroll", 'other': ['StackSize >= 20'], "class": "Currency", "type": "currency high"},
	...
	"08 Splinter of Chayula": {"base": "Splinter of Chayula", 'other': ['StackSize >= 19'], "class": "Currency", "type": "currency very high"},
	...
	"07 Splinter of Uul-Netol": {"base": "Splinter of Uul-Netol", 'other': ['StackSize >= 95'], "class": "Currency", "type": "currency very high"},
