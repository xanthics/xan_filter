...
items = {
	...
	"08 Ancient Orb": {"base": "Ancient Orb", 'other': ['StackSize >= 13'], "class": "Currency", "type": "currency extremely high"},
	...
	"09 Horizon Shard": {"base": "Horizon Shard", 'other': ['StackSize >= 10'], "class": "Currency", "type": "currency normal"},
	...
	"08 Splinter of Esh": {"base": "Splinter of Esh", 'other': ['StackSize >= 13'], "class": "Currency", "type": "currency high"},
	...
	"07 Splinter of Uul-Netol": {"base": "Splinter of Uul-Netol", 'other': ['StackSize >= 89'], "class": "Currency", "type": "currency very high"},
	...
	"07 Splinter of Xoph": {"base": "Splinter of Xoph", 'other': ['StackSize >= 94'], "class": "Currency", "type": "currency very high"},
