...
items = {
	...
	"08 Alchemy Shard": {"base": "Alchemy Shard", 'other': ['StackSize >= 13'], "class": "Currency", "type": "currency normal"},
	"1 Alteration Shard": {"base": "Alteration Shard", "class": "Currency", "type": "currency very low"},
	"09 Alteration Shard": {"base": "Alteration Shard", 'other': ['StackSize >= 20'], "class": "Currency", "type": "currency low"},
	"1 Ancient Orb": {"base": "Ancient Orb", "class": "Currency", "type": "currency very high"},
	"09 Ancient Orb": {"base": "Ancient Orb", 'other': ['StackSize >= 3'], "class": "Currency", "type": "currency extremely high"},
	...
	"08 Apprentice Cartographer's Sextant": {"base": "Apprentice Cartographer's Sextant", 'other': ['StackSize >= 7'], "class": "Currency", "type": "currency very high"},
	...
	"08 Armourer's Scrap": {"base": "Armourer's Scrap", 'other': ['StackSize >= 5'], "class": "Currency", "type": "currency normal"},
	"07 Armourer's Scrap": {"base": "Armourer's Scrap", 'other': ['StackSize >= 20'], "class": "Currency", "type": "currency high"},
	...
	"08 Blessed Orb": {"base": "Blessed Orb", 'other': ['StackSize >= 10'], "class": "Currency", "type": "currency very high"},
	...
	"09 Divine Orb": {"base": "Divine Orb", 'other': ['StackSize >= 9'], "class": "Currency", "type": "currency extremely high"},
	...
	"09 Engineer's Orb": {"base": "Engineer's Orb", 'other': ['StackSize >= 3'], "class": "Currency", "type": "currency very high"},
	"1 Engineer's Shard": {"base": "Engineer's Shard", "class": "Currency", "type": "currency low"},
	"09 Engineer's Shard": {"base": "Engineer's Shard", 'other': ['StackSize >= 3'], "class": "Currency", "type": "currency normal"},
	"08 Engineer's Shard": {"base": "Engineer's Shard", 'other': ['StackSize >= 12'], "class": "Currency", "type": "currency high"},
	...
	"09 Harbinger's Orb": {"base": "Harbinger's Orb", 'other': ['StackSize >= 5'], "class": "Currency", "type": "currency extremely high"},
	...
	"08 Harbinger's Shard": {"base": "Harbinger's Shard", 'other': ['StackSize >= 10'], "class": "Currency", "type": "currency very high"},
	...
	"09 Horizon Shard": {"base": "Horizon Shard", 'other': ['StackSize >= 3'], "class": "Currency", "type": "currency normal"},
	"08 Horizon Shard": {"base": "Horizon Shard", 'other': ['StackSize >= 9'], "class": "Currency", "type": "currency high"},
	...
	"09 Journeyman Cartographer's Sextant": {"base": "Journeyman Cartographer's Sextant", 'other': ['StackSize >= 3'], "class": "Currency", "type": "currency very high"},
	...
	"08 Master Cartographer's Sextant": {"base": "Master Cartographer's Sextant", 'other': ['StackSize >= 14'], "class": "Currency", "type": "currency extremely high"},
	...
	"08 Orb of Alchemy": {"base": "Orb of Alchemy", 'other': ['StackSize >= 13'], "class": "Currency", "type": "currency very high"},
	...
	"09 Orb of Annulment": {"base": "Orb of Annulment", 'other': ['StackSize >= 6'], "class": "Currency", "type": "currency extremely high"},
	...
	"08 Orb of Augmentation": {"base": "Orb of Augmentation", 'other': ['StackSize >= 17'], "class": "Currency", "type": "currency high"},
	...
	"08 Orb of Fusing": {"base": "Orb of Fusing", 'other': ['StackSize >= 16'], "class": "Currency", "type": "currency very high"},
	"1 Orb of Horizons": {"base": "Orb of Horizons", "class": "Currency", "type": "currency high"},
	"09 Orb of Horizons": {"base": "Orb of Horizons", 'other': ['StackSize >= 3'], "class": "Currency", "type": "currency very high"},
	...
	"08 Orb of Regret": {"base": "Orb of Regret", 'other': ['StackSize >= 6'], "class": "Currency", "type": "currency very high"},
	...
	"08 Orb of Scouring": {"base": "Orb of Scouring", 'other': ['StackSize >= 11'], "class": "Currency", "type": "currency very high"},
	"1 Orb of Transmutation": {"base": "Orb of Transmutation", "class": "Currency", "type": "currency show"},
	"09 Orb of Transmutation": {"base": "Orb of Transmutation", 'other': ['StackSize >= 5'], "class": "Currency", "type": "currency normal"},
	"08 Orb of Transmutation": {"base": "Orb of Transmutation", 'other': ['StackSize >= 20'], "class": "Currency", "type": "currency high"},
	...
	"09 Portal Scroll": {"base": "Portal Scroll", 'other': ['StackSize >= 4'], "class": "Currency", "type": "currency low"},
	"08 Portal Scroll": {"base": "Portal Scroll", 'other': ['StackSize >= 13'], "class": "Currency", "type": "currency normal"},
	...
	"09 Regal Orb": {"base": "Regal Orb", 'other': ['StackSize >= 4'], "class": "Currency", "type": "currency very high"},
	...
	"09 Splinter of Chayula": {"base": "Splinter of Chayula", 'other': ['StackSize >= 5'], "class": "Currency", "type": "currency very high"},
	...
	"08 Splinter of Esh": {"base": "Splinter of Esh", 'other': ['StackSize >= 16'], "class": "Currency", "type": "currency very high"},
	"1 Splinter of Tul": {"base": "Splinter of Tul", "class": "Currency", "type": "currency normal"},
	"09 Splinter of Tul": {"base": "Splinter of Tul", 'other': ['StackSize >= 3'], "class": "Currency", "type": "currency high"},
	"08 Splinter of Tul": {"base": "Splinter of Tul", 'other': ['StackSize >= 13'], "class": "Currency", "type": "currency very high"},
	...
	"08 Splinter of Uul-Netol": {"base": "Splinter of Uul-Netol", 'other': ['StackSize >= 16'], "class": "Currency", "type": "currency very high"},
	...
	"08 Splinter of Xoph": {"base": "Splinter of Xoph", 'other': ['StackSize >= 17'], "class": "Currency", "type": "currency very high"},
