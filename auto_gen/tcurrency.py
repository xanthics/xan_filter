...
items = {
	...
	"08 Horizon Shard": {"base": "Horizon Shard", 'other': ['StackSize >= 11'], "class": "Currency", "type": "currency high"},
	...
	"08 Perandus Coin": {"base": "Perandus Coin", 'other': ['StackSize >= 10'], "class": "Currency", "type": "currency high"},
