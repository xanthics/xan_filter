...
items = {
	...
	"08 Engineer's Shard": {"base": "Engineer's Shard", 'other': ['StackSize >= 18'], "class": "Currency", "type": "currency normal"},
	...
	"08 Harbinger's Orb": {"base": "Harbinger's Orb", 'other': ['StackSize >= 11'], "class": "Currency", "type": "currency extremely high"},
