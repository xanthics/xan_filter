...
items = {
	...
	"08 Alchemy Shard": {"base": "Alchemy Shard", 'other': ['StackSize >= 15'], "class": "Currency", "type": "currency normal"},
	...
	"09 Engineer's Shard": {"base": "Engineer's Shard", 'other': ['StackSize >= 7'], "class": "Currency", "type": "currency low"},
	...
	"08 Harbinger's Shard": {"base": "Harbinger's Shard", 'other': ['StackSize >= 15'], "class": "Currency", "type": "currency very high"},
