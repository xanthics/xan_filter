...
items = {
	...
	"09 Alchemy Shard": {"base": "Alchemy Shard", 'other': ['StackSize >= 6'], "class": "Currency", "type": "currency low"},
	"08 Alchemy Shard": {"base": "Alchemy Shard", 'other': ['StackSize >= 20'], "class": "Currency", "type": "currency normal"},
	...
	"1 Blacksmith's Whetstone": {"base": "Blacksmith's Whetstone", "class": "Currency", "type": "currency low"},
	"09 Blacksmith's Whetstone": {"base": "Blacksmith's Whetstone", 'other': ['StackSize >= 3'], "class": "Currency", "type": "currency normal"},
	"08 Blacksmith's Whetstone": {"base": "Blacksmith's Whetstone", 'other': ['StackSize >= 12'], "class": "Currency", "type": "currency high"},
	...
	"08 Blessed Orb": {"base": "Blessed Orb", 'other': ['StackSize >= 13'], "class": "Currency", "type": "currency very high"},
	...
	"08 Chromatic Orb": {"base": "Chromatic Orb", 'other': ['StackSize >= 20'], "class": "Currency", "type": "currency high"},
	...
	"08 Engineer's Shard": {"base": "Engineer's Shard", 'other': ['StackSize >= 5'], "class": "Currency", "type": "currency normal"},
	"07 Engineer's Shard": {"base": "Engineer's Shard", 'other': ['StackSize >= 20'], "class": "Currency", "type": "currency high"},
	...
	"09 Harbinger's Orb": {"base": "Harbinger's Orb", 'other': ['StackSize >= 4'], "class": "Currency", "type": "currency very high"},
	"1 Harbinger's Shard": {"base": "Harbinger's Shard", "class": "Currency", "type": "currency low"},
	"09 Harbinger's Shard": {"base": "Harbinger's Shard", 'other': ['StackSize >= 4'], "class": "Currency", "type": "currency normal"},
	"08 Harbinger's Shard": {"base": "Harbinger's Shard", 'other': ['StackSize >= 14'], "class": "Currency", "type": "currency high"},
	...
	"08 Horizon Shard": {"base": "Horizon Shard", 'other': ['StackSize >= 7'], "class": "Currency", "type": "currency normal"},
	...
	"08 Jeweller's Orb": {"base": "Jeweller's Orb", 'other': ['StackSize >= 7'], "class": "Currency", "type": "currency normal"},
	...
	"09 Orb of Annulment": {"base": "Orb of Annulment", 'other': ['StackSize >= 4'], "class": "Currency", "type": "currency very high"},
	...
	"08 Orb of Augmentation": {"base": "Orb of Augmentation", 'other': ['StackSize >= 5'], "class": "Currency", "type": "currency normal"},
	"07 Orb of Augmentation": {"base": "Orb of Augmentation", 'other': ['StackSize >= 20'], "class": "Currency", "type": "currency high"},
	...
	"08 Orb of Fusing": {"base": "Orb of Fusing", 'other': ['StackSize >= 6'], "class": "Currency", "type": "currency high"},
	...
	"08 Orb of Scouring": {"base": "Orb of Scouring", 'other': ['StackSize >= 20'], "class": "Currency", "type": "currency very high"},
	...
	"08 Orb of Transmutation": {"base": "Orb of Transmutation", 'other': ['StackSize >= 5'], "class": "Currency", "type": "currency normal"},
	"07 Orb of Transmutation": {"base": "Orb of Transmutation", 'other': ['StackSize >= 20'], "class": "Currency", "type": "currency high"},
	"1 Perandus Coin": {"base": "Perandus Coin", "class": "Currency", "type": "currency normal"},
	"09 Perandus Coin": {"base": "Perandus Coin", 'other': ['StackSize >= 3'], "class": "Currency", "type": "currency high"},
	"08 Perandus Coin": {"base": "Perandus Coin", 'other': ['StackSize >= 11'], "class": "Currency", "type": "currency very high"},
	...
	"08 Regal Orb": {"base": "Regal Orb", 'other': ['StackSize >= 7'], "class": "Currency", "type": "currency very high"},
	...
	"08 Splinter of Esh": {"base": "Splinter of Esh", 'other': ['StackSize >= 11'], "class": "Currency", "type": "currency very high"},
	"1 Splinter of Tul": {"base": "Splinter of Tul", "class": "Currency", "type": "currency normal"},
	"09 Splinter of Tul": {"base": "Splinter of Tul", 'other': ['StackSize >= 2'], "class": "Currency", "type": "currency high"},
	"08 Splinter of Tul": {"base": "Splinter of Tul", 'other': ['StackSize >= 10'], "class": "Currency", "type": "currency very high"},
	...
	"08 Splinter of Uul-Netol": {"base": "Splinter of Uul-Netol", 'other': ['StackSize >= 10'], "class": "Currency", "type": "currency very high"},
	...
	"08 Splinter of Xoph": {"base": "Splinter of Xoph", 'other': ['StackSize >= 16'], "class": "Currency", "type": "currency very high"},
