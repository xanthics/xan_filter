...
items = {
	...
	"1 Armourer's Scrap": {"base": "Armourer's Scrap", "class": "Currency", "type": "currency show"},
	"09 Armourer's Scrap": {"base": "Armourer's Scrap", 'other': ['StackSize >= 5'], "class": "Currency", "type": "currency normal"},
	"08 Armourer's Scrap": {"base": "Armourer's Scrap", 'other': ['StackSize >= 20'], "class": "Currency", "type": "currency high"},
	"1 Binding Shard": {"base": "Binding Shard", "class": "Currency", "type": "currency very low"},
	"09 Binding Shard": {"base": "Binding Shard", 'other': ['StackSize >= 6'], "class": "Currency", "type": "currency low"},
	"08 Binding Shard": {"base": "Binding Shard", 'other': ['StackSize >= 12'], "class": "Currency", "type": "currency normal"},
	...
	"08 Blacksmith's Whetstone": {"base": "Blacksmith's Whetstone", 'other': ['StackSize >= 20'], "class": "Currency", "type": "currency high"},
	"1 Blessed Orb": {"base": "Blessed Orb", "class": "Currency", "type": "currency show"},
	"09 Blessed Orb": {"base": "Blessed Orb", 'other': ['StackSize >= 9'], "class": "Currency", "type": "currency normal"},
	...
	"09 Engineer's Orb": {"base": "Engineer's Orb", 'other': ['StackSize >= 12'], "class": "Currency", "type": "currency very high"},
	...
	"07 Engineer's Shard": {"base": "Engineer's Shard", 'other': ['StackSize >= 14'], "class": "Currency", "type": "currency high"},
	...
	"08 Harbinger's Orb": {"base": "Harbinger's Orb", 'other': ['StackSize >= 12'], "class": "Currency", "type": "currency extremely high"},
	...
	"09 Horizon Shard": {"base": "Horizon Shard", 'other': ['StackSize >= 6'], "class": "Currency", "type": "currency low"},
	"08 Horizon Shard": {"base": "Horizon Shard", 'other': ['StackSize >= 12'], "class": "Currency", "type": "currency normal"},
	...
	"08 Orb of Augmentation": {"base": "Orb of Augmentation", 'other': ['StackSize >= 20'], "class": "Currency", "type": "currency high"},
	...
	"08 Orb of Chance": {"base": "Orb of Chance", 'other': ['StackSize >= 12'], "class": "Currency", "type": "currency high"},
	...
	"07 Perandus Coin": {"base": "Perandus Coin", 'other': ['StackSize >= 850'], "class": "Currency", "type": "currency very high"},
	...
	"09 Regal Shard": {"base": "Regal Shard", 'other': ['StackSize >= 8'], "class": "Currency", "type": "currency low"},
	"08 Regal Shard": {"base": "Regal Shard", 'other': ['StackSize >= 16'], "class": "Currency", "type": "currency normal"},
	...
	"09 Scroll of Wisdom": {"base": "Scroll of Wisdom", 'other': ['StackSize >= 13'], "class": "Currency", "type": "currency low"},
	"08 Scroll of Wisdom": {"base": "Scroll of Wisdom", 'other': ['StackSize >= 25'], "class": "Currency", "type": "currency normal"},
