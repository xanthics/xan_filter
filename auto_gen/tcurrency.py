...
items = {
	...
	"08 Alchemy Shard": {"base": "Alchemy Shard", 'other': ['StackSize >= 14'], "class": "Currency", "type": "currency normal"},
	"1 Alteration Shard": {"base": "Alteration Shard", "class": "Currency", "type": "currency very low"},
	"09 Alteration Shard": {"base": "Alteration Shard", 'other': ['StackSize >= 5'], "class": "Currency", "type": "currency low"},
	"08 Alteration Shard": {"base": "Alteration Shard", 'other': ['StackSize >= 18'], "class": "Currency", "type": "currency normal"},
	"1 Ancient Orb": {"base": "Ancient Orb", "class": "Currency", "type": "currency very high"},
	"09 Ancient Orb": {"base": "Ancient Orb", 'other': ['StackSize >= 2'], "class": "Currency", "type": "currency extremely high"},
	"1 Ancient Shard": {"base": "Ancient Shard", "class": "Currency", "type": "currency high"},
	"09 Ancient Shard": {"base": "Ancient Shard", 'other': ['StackSize >= 4'], "class": "Currency", "type": "currency very high"},
	"1 Annulment Shard": {"base": "Annulment Shard", "class": "Currency", "type": "currency high"},
	"09 Annulment Shard": {"base": "Annulment Shard", 'other': ['StackSize >= 5'], "class": "Currency", "type": "currency very high"},
	...
	"08 Apprentice Cartographer's Sextant": {"base": "Apprentice Cartographer's Sextant", 'other': ['StackSize >= 8'], "class": "Currency", "type": "currency very high"},
	"1 Armourer's Scrap": {"base": "Armourer's Scrap", "class": "Currency", "type": "currency normal"},
	"09 Armourer's Scrap": {"base": "Armourer's Scrap", 'other': ['StackSize >= 3'], "class": "Currency", "type": "currency high"},
	"08 Armourer's Scrap": {"base": "Armourer's Scrap", 'other': ['StackSize >= 14'], "class": "Currency", "type": "currency very high"},
	"1 Binding Shard": {"base": "Binding Shard", "class": "Currency", "type": "currency very low"},
	"09 Binding Shard": {"base": "Binding Shard", 'other': ['StackSize >= 2'], "class": "Currency", "type": "currency low"},
	"08 Binding Shard": {"base": "Binding Shard", 'other': ['StackSize >= 5'], "class": "Currency", "type": "currency normal"},
	"07 Binding Shard": {"base": "Binding Shard", 'other': ['StackSize >= 20'], "class": "Currency", "type": "currency high"},
	"1 Blacksmith's Whetstone": {"base": "Blacksmith's Whetstone", "class": "Currency", "type": "currency normal"},
	"09 Blacksmith's Whetstone": {"base": "Blacksmith's Whetstone", 'other': ['StackSize >= 4'], "class": "Currency", "type": "currency high"},
	"08 Blacksmith's Whetstone": {"base": "Blacksmith's Whetstone", 'other': ['StackSize >= 17'], "class": "Currency", "type": "currency very high"},
	"1 Blessed Orb": {"base": "Blessed Orb", "class": "Currency", "type": "currency normal"},
	"09 Blessed Orb": {"base": "Blessed Orb", 'other': ['StackSize >= 2'], "class": "Currency", "type": "currency high"},
	"08 Blessed Orb": {"base": "Blessed Orb", 'other': ['StackSize >= 8'], "class": "Currency", "type": "currency very high"},
	...
	"08 Cartographer's Chisel": {"base": "Cartographer's Chisel", 'other': ['StackSize >= 16'], "class": "Currency", "type": "currency very high"},
	"1 Chaos Orb": {"base": "Chaos Orb", "class": "Currency", "type": "currency high"},
	"09 Chaos Orb": {"base": "Chaos Orb", 'other': ['StackSize >= 5'], "class": "Currency", "type": "currency very high"},
	"1 Chromatic Orb": {"base": "Chromatic Orb", "class": "Currency", "type": "currency normal"},
	"09 Chromatic Orb": {"base": "Chromatic Orb", 'other': ['StackSize >= 4'], "class": "Currency", "type": "currency high"},
	"08 Chromatic Orb": {"base": "Chromatic Orb", 'other': ['StackSize >= 18'], "class": "Currency", "type": "currency very high"},
	...
	"08 Divine Orb": {"base": "Divine Orb", 'other': ['StackSize >= 14'], "class": "Currency", "type": "currency extremely high"},
	...
	"08 Engineer's Orb": {"base": "Engineer's Orb", 'other': ['StackSize >= 8'], "class": "Currency", "type": "currency very high"},
	"1 Engineer's Shard": {"base": "Engineer's Shard", "class": "Currency", "type": "currency very low"},
	"09 Engineer's Shard": {"base": "Engineer's Shard", 'other': ['StackSize >= 2'], "class": "Currency", "type": "currency low"},
	...
	"1 Exalted Shard": {"base": "Exalted Shard", "class": "Currency", "type": "currency very high"},
	"09 Exalted Shard": {"base": "Exalted Shard", 'other': ['StackSize >= 9'], "class": "Currency", "type": "currency extremely high"},
	...
	"1 Frigid Fossil": {"base": "Frigid Fossil", "class": "Currency", "type": "currency high"},
	...
	"08 Glassblower's Bauble": {"base": "Glassblower's Bauble", 'other': ['StackSize >= 14'], "class": "Currency", "type": "currency very high"},
	"1 Glyphic Fossil": {"base": "Glyphic Fossil", "class": "Currency", "type": "currency extremely high"},
	"1 Harbinger's Orb": {"base": "Harbinger's Orb", "class": "Currency", "type": "currency very high"},
	"09 Harbinger's Orb": {"base": "Harbinger's Orb", 'other': ['StackSize >= 6'], "class": "Currency", "type": "currency extremely high"},
	"1 Harbinger's Shard": {"base": "Harbinger's Shard", "class": "Currency", "type": "currency normal"},
	"09 Harbinger's Shard": {"base": "Harbinger's Shard", 'other': ['StackSize >= 3'], "class": "Currency", "type": "currency high"},
	"08 Harbinger's Shard": {"base": "Harbinger's Shard", 'other': ['StackSize >= 12'], "class": "Currency", "type": "currency very high"},
	"1 Hollow Fossil": {"base": "Hollow Fossil", "class": "Currency", "type": "currency extremely high"},
	...
	"1 Jeweller's Orb": {"base": "Jeweller's Orb", "class": "Currency", "type": "currency normal"},
	"09 Jeweller's Orb": {"base": "Jeweller's Orb", 'other': ['StackSize >= 4'], "class": "Currency", "type": "currency high"},
	"08 Jeweller's Orb": {"base": "Jeweller's Orb", 'other': ['StackSize >= 18'], "class": "Currency", "type": "currency very high"},
	...
	"08 Master Cartographer's Sextant": {"base": "Master Cartographer's Sextant", 'other': ['StackSize >= 15'], "class": "Currency", "type": "currency extremely high"},
	...
	"08 Orb of Alchemy": {"base": "Orb of Alchemy", 'other': ['StackSize >= 14'], "class": "Currency", "type": "currency very high"},
	"1 Orb of Alteration": {"base": "Orb of Alteration", "class": "Currency", "type": "currency normal"},
	"09 Orb of Alteration": {"base": "Orb of Alteration", 'other': ['StackSize >= 4'], "class": "Currency", "type": "currency high"},
	"08 Orb of Alteration": {"base": "Orb of Alteration", 'other': ['StackSize >= 18'], "class": "Currency", "type": "currency very high"},
	"1 Orb of Annulment": {"base": "Orb of Annulment", "class": "Currency", "type": "currency high"},
	"09 Orb of Annulment": {"base": "Orb of Annulment", 'other': ['StackSize >= 2'], "class": "Currency", "type": "currency very high"},
	"08 Orb of Annulment": {"base": "Orb of Annulment", 'other': ['StackSize >= 13'], "class": "Currency", "type": "currency extremely high"},
	"1 Orb of Augmentation": {"base": "Orb of Augmentation", "class": "Currency", "type": "currency normal"},
	"09 Orb of Augmentation": {"base": "Orb of Augmentation", 'other': ['StackSize >= 4'], "class": "Currency", "type": "currency high"},
	"08 Orb of Augmentation": {"base": "Orb of Augmentation", 'other': ['StackSize >= 20'], "class": "Currency", "type": "currency very high"},
	"1 Orb of Binding": {"base": "Orb of Binding", "class": "Currency", "type": "currency high"},
	"09 Orb of Binding": {"base": "Orb of Binding", 'other': ['StackSize >= 5'], "class": "Currency", "type": "currency very high"},
	"1 Orb of Chance": {"base": "Orb of Chance", "class": "Currency", "type": "currency normal"},
	"09 Orb of Chance": {"base": "Orb of Chance", 'other': ['StackSize >= 4'], "class": "Currency", "type": "currency high"},
	"08 Orb of Chance": {"base": "Orb of Chance", 'other': ['StackSize >= 17'], "class": "Currency", "type": "currency very high"},
	...
	"08 Orb of Horizons": {"base": "Orb of Horizons", 'other': ['StackSize >= 6'], "class": "Currency", "type": "currency very high"},
	...
	"08 Orb of Regret": {"base": "Orb of Regret", 'other': ['StackSize >= 7'], "class": "Currency", "type": "currency very high"},
	...
	"08 Orb of Scouring": {"base": "Orb of Scouring", 'other': ['StackSize >= 12'], "class": "Currency", "type": "currency very high"},
	"1 Orb of Transmutation": {"base": "Orb of Transmutation", "class": "Currency", "type": "currency normal"},
	"09 Orb of Transmutation": {"base": "Orb of Transmutation", 'other': ['StackSize >= 4'], "class": "Currency", "type": "currency high"},
	"08 Orb of Transmutation": {"base": "Orb of Transmutation", 'other': ['StackSize >= 18'], "class": "Currency", "type": "currency very high"},
	...
	"09 Regal Orb": {"base": "Regal Orb", 'other': ['StackSize >= 5'], "class": "Currency", "type": "currency very high"},
	...
	"1 Silver Coin": {"base": "Silver Coin", "class": "Currency", "type": "currency normal"},
	"09 Silver Coin": {"base": "Silver Coin", 'other': ['StackSize >= 4'], "class": "Currency", "type": "currency high"},
	"08 Silver Coin": {"base": "Silver Coin", 'other': ['StackSize >= 16'], "class": "Currency", "type": "currency very high"},
	...
	"08 Splinter of Chayula": {"base": "Splinter of Chayula", 'other': ['StackSize >= 7'], "class": "Currency", "type": "currency very high"},
	...
	"08 Splinter of Esh": {"base": "Splinter of Esh", 'other': ['StackSize >= 17'], "class": "Currency", "type": "currency very high"},
	"1 Splinter of Tul": {"base": "Splinter of Tul", "class": "Currency", "type": "currency normal"},
	"09 Splinter of Tul": {"base": "Splinter of Tul", 'other': ['StackSize >= 4'], "class": "Currency", "type": "currency high"},
	"08 Splinter of Tul": {"base": "Splinter of Tul", 'other': ['StackSize >= 18'], "class": "Currency", "type": "currency very high"},
	"1 Splinter of Uul-Netol": {"base": "Splinter of Uul-Netol", "class": "Currency", "type": "currency normal"},
	"09 Splinter of Uul-Netol": {"base": "Splinter of Uul-Netol", 'other': ['StackSize >= 4'], "class": "Currency", "type": "currency high"},
	"08 Splinter of Uul-Netol": {"base": "Splinter of Uul-Netol", 'other': ['StackSize >= 18'], "class": "Currency", "type": "currency very high"},
	...
	"09 Transmutation Shard": {"base": "Transmutation Shard", 'other': ['StackSize >= 5'], "class": "Currency", "type": "currency low"},
	"08 Transmutation Shard": {"base": "Transmutation Shard", 'other': ['StackSize >= 18'], "class": "Currency", "type": "currency normal"},
	...
	"08 Vaal Orb": {"base": "Vaal Orb", 'other': ['StackSize >= 13'], "class": "Currency", "type": "currency very high"},
