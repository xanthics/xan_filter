...
items = {
	...
	"08 Alchemy Shard": {"base": "Alchemy Shard", 'other': ['StackSize >= 4'], "class": "Currency", "type": "currency low"},
	"07 Alchemy Shard": {"base": "Alchemy Shard", 'other': ['StackSize >= 14'], "class": "Currency", "type": "currency normal"},
	...
	"08 Ancient Shard": {"base": "Ancient Shard", 'other': ['StackSize >= 12'], "class": "Currency", "type": "currency very high"},
	"1 Annulment Shard": {"base": "Annulment Shard", "class": "Currency", "type": "currency very high"},
	"09 Annulment Shard": {"base": "Annulment Shard", 'other': ['StackSize >= 7'], "class": "Currency", "type": "currency extremely high"},
	...
	"07 Binding Shard": {"base": "Binding Shard", 'other': ['StackSize >= 9'], "class": "Currency", "type": "currency normal"},
	...
	"1 Bound Fossil": {"base": "Bound Fossil", "class": "Currency", "type": "currency normal"},
	...
	"07 Horizon Shard": {"base": "Horizon Shard", 'other': ['StackSize >= 18'], "class": "Currency", "type": "currency high"},
	...
	"09 Mirror Shard": {"base": "Mirror Shard", 'other': ['StackSize >= 4'], "class": "Currency", "type": "currency extremely high"},
	...
	"08 Orb of Alteration": {"base": "Orb of Alteration", 'other': ['StackSize >= 11'], "class": "Currency", "type": "currency high"},
	...
	"09 Orb of Horizons": {"base": "Orb of Horizons", 'other': ['StackSize >= 6'], "class": "Currency", "type": "currency very high"},
	...
	"09 Perandus Coin": {"base": "Perandus Coin", 'other': ['StackSize >= 2'], "class": "Currency", "type": "currency high"},
	"08 Perandus Coin": {"base": "Perandus Coin", 'other': ['StackSize >= 8'], "class": "Currency", "type": "currency very high"},
	...
	"08 Splinter of Tul": {"base": "Splinter of Tul", 'other': ['StackSize >= 15'], "class": "Currency", "type": "currency high"},
