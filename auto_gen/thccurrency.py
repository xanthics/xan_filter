...
items = {
	...
	"08 Blessed Orb": {"base": "Blessed Orb", 'other': ['StackSize >= 9'], "class": "Currency", "type": "currency very high"},
	...
	"08 Cartographer's Chisel": {"base": "Cartographer's Chisel", 'other': ['StackSize >= 19'], "class": "Currency", "type": "currency very high"},
	...
	"09 Divine Orb": {"base": "Divine Orb", 'other': ['StackSize >= 10'], "class": "Currency", "type": "currency extremely high"},
	...
	"08 Horizon Shard": {"base": "Horizon Shard", 'other': ['StackSize >= 14'], "class": "Currency", "type": "currency high"},
	...
	"07 Orb of Alteration": {"base": "Orb of Alteration", 'other': ['StackSize >= 17'], "class": "Currency", "type": "currency high"},
	...
	"08 Orb of Annulment": {"base": "Orb of Annulment", 'other': ['StackSize >= 14'], "class": "Currency", "type": "currency extremely high"},
	...
	"09 Orb of Horizons": {"base": "Orb of Horizons", 'other': ['StackSize >= 4'], "class": "Currency", "type": "currency very high"},
	...
	"1 Regal Shard": {"base": "Regal Shard", "class": "Currency", "type": "currency low"},
	"09 Regal Shard": {"base": "Regal Shard", 'other': ['StackSize >= 4'], "class": "Currency", "type": "currency normal"},
	"08 Regal Shard": {"base": "Regal Shard", 'other': ['StackSize >= 15'], "class": "Currency", "type": "currency high"},
	...
	"08 Splinter of Tul": {"base": "Splinter of Tul", 'other': ['StackSize >= 7'], "class": "Currency", "type": "currency high"},
	...
	"08 Splinter of Uul-Netol": {"base": "Splinter of Uul-Netol", 'other': ['StackSize >= 20'], "class": "Currency", "type": "currency very high"},
	...
	"08 Splinter of Xoph": {"base": "Splinter of Xoph", 'other': ['StackSize >= 19'], "class": "Currency", "type": "currency very high"},
