...
items = {
	...
	"08 Annulment Shard": {"base": "Annulment Shard", 'other': ['StackSize >= 11'], "class": "Currency", "type": "currency very high"},
	...
	"08 Harbinger's Shard": {"base": "Harbinger's Shard", 'other': ['StackSize >= 11'], "class": "Currency", "type": "currency very high"},
	...
	"08 Orb of Fusing": {"base": "Orb of Fusing", 'other': ['StackSize >= 10'], "class": "Currency", "type": "currency very high"},
	...
	"08 Regal Shard": {"base": "Regal Shard", 'other': ['StackSize >= 9'], "class": "Currency", "type": "currency normal"},
