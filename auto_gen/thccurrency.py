...
items = {
	...
	"08 Cartographer's Chisel": {"base": "Cartographer's Chisel", 'other': ['StackSize >= 18'], "class": "Currency", "type": "currency very high"},
	...
	"08 Orb of Alchemy": {"base": "Orb of Alchemy", 'other': ['StackSize >= 12'], "class": "Currency", "type": "currency very high"},
	...
	"1 Serrated Fossil": {"base": "Serrated Fossil", "class": "Currency", "type": "currency normal"},
	...
	"08 Splinter of Esh": {"base": "Splinter of Esh", 'other': ['StackSize >= 7'], "class": "Currency", "type": "currency high"},
	...
	"08 Splinter of Tul": {"base": "Splinter of Tul", 'other': ['StackSize >= 8'], "class": "Currency", "type": "currency high"},
