...
items = {
	...
	"09 Armourer's Scrap": {"base": "Armourer's Scrap", 'other': ['StackSize >= 3'], "class": "Currency", "type": "currency very low"},
	"08 Armourer's Scrap": {"base": "Armourer's Scrap", 'other': ['StackSize >= 6'], "class": "Currency", "type": "currency low"},
	"07 Armourer's Scrap": {"base": "Armourer's Scrap", 'other': ['StackSize >= 12'], "class": "Currency", "type": "currency normal"},
	...
	"08 Binding Shard": {"base": "Binding Shard", 'other': ['StackSize >= 7'], "class": "Currency", "type": "currency low"},
	"07 Binding Shard": {"base": "Binding Shard", 'other': ['StackSize >= 14'], "class": "Currency", "type": "currency normal"},
	"1 Blacksmith's Whetstone": {"base": "Blacksmith's Whetstone", "class": "Currency", "type": "hide"},
	"09 Blacksmith's Whetstone": {"base": "Blacksmith's Whetstone", 'other': ['StackSize >= 3'], "class": "Currency", "type": "currency very low"},
	"08 Blacksmith's Whetstone": {"base": "Blacksmith's Whetstone", 'other': ['StackSize >= 6'], "class": "Currency", "type": "currency low"},
	"07 Blacksmith's Whetstone": {"base": "Blacksmith's Whetstone", 'other': ['StackSize >= 12'], "class": "Currency", "type": "currency normal"},
	...
	"09 Engineer's Shard": {"base": "Engineer's Shard", 'other': ['StackSize >= 6'], "class": "Currency", "type": "currency very low"},
	"08 Engineer's Shard": {"base": "Engineer's Shard", 'other': ['StackSize >= 11'], "class": "Currency", "type": "currency low"},
	...
	"09 Orb of Transmutation": {"base": "Orb of Transmutation", 'other': ['StackSize >= 3'], "class": "Currency", "type": "currency very low"},
	"08 Orb of Transmutation": {"base": "Orb of Transmutation", 'other': ['StackSize >= 6'], "class": "Currency", "type": "currency low"},
	"07 Orb of Transmutation": {"base": "Orb of Transmutation", 'other': ['StackSize >= 12'], "class": "Currency", "type": "currency normal"},
	...
	"08 Portal Scroll": {"base": "Portal Scroll", 'other': ['StackSize >= 6'], "class": "Currency", "type": "currency low"},
	"07 Portal Scroll": {"base": "Portal Scroll", 'other': ['StackSize >= 12'], "class": "Currency", "type": "currency normal"},
	...
	"09 Scroll of Wisdom": {"base": "Scroll of Wisdom", 'other': ['StackSize >= 6'], "class": "Currency", "type": "currency very low"},
	"08 Scroll of Wisdom": {"base": "Scroll of Wisdom", 'other': ['StackSize >= 12'], "class": "Currency", "type": "currency low"},
