...
items = {
	...
	"08 Alteration Shard": {"base": "Alteration Shard", 'other': ['StackSize >= 12'], "class": "Currency", "type": "currency low"},
	...
	"08 Orb of Binding": {"base": "Orb of Binding", 'other': ['StackSize >= 19'], "class": "Currency", "type": "currency very high"},
