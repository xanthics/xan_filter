...
items = {
	...
	"09 Alteration Shard": {"base": "Alteration Shard", 'other': ['StackSize >= 14'], "class": "Currency", "type": "currency low"},
	...
	"09 Ancient Shard": {"base": "Ancient Shard", 'other': ['StackSize >= 4'], "class": "Currency", "type": "currency high"},
	"08 Ancient Shard": {"base": "Ancient Shard", 'other': ['StackSize >= 17'], "class": "Currency", "type": "currency very high"},
	...
	"08 Binding Shard": {"base": "Binding Shard", 'other': ['StackSize >= 10'], "class": "Currency", "type": "currency normal"},
	"1 Blacksmith's Whetstone": {"base": "Blacksmith's Whetstone", "class": "Currency", "type": "currency very low"},
	"09 Blacksmith's Whetstone": {"base": "Blacksmith's Whetstone", 'other': ['StackSize >= 3'], "class": "Currency", "type": "currency low"},
	"08 Blacksmith's Whetstone": {"base": "Blacksmith's Whetstone", 'other': ['StackSize >= 9'], "class": "Currency", "type": "currency normal"},
	...
	"08 Blessed Orb": {"base": "Blessed Orb", 'other': ['StackSize >= 16'], "class": "Currency", "type": "currency very high"},
	...
	"08 Cartographer's Chisel": {"base": "Cartographer's Chisel", 'other': ['StackSize >= 17'], "class": "Currency", "type": "currency very high"},
	...
	"08 Glassblower's Bauble": {"base": "Glassblower's Bauble", 'other': ['StackSize >= 16'], "class": "Currency", "type": "currency very high"},
	...
	"08 Jeweller's Orb": {"base": "Jeweller's Orb", 'other': ['StackSize >= 10'], "class": "Currency", "type": "currency high"},
	...
	"09 Orb of Annulment": {"base": "Orb of Annulment", 'other': ['StackSize >= 4'], "class": "Currency", "type": "currency extremely high"},
	...
	"08 Orb of Binding": {"base": "Orb of Binding", 'other': ['StackSize >= 10'], "class": "Currency", "type": "currency very high"},
	...
	"08 Orb of Chance": {"base": "Orb of Chance", 'other': ['StackSize >= 13'], "class": "Currency", "type": "currency high"},
