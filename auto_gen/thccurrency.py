...
items = {
	...
	"08 Apprentice Cartographer's Sextant": {"base": "Apprentice Cartographer's Sextant", 'other': ['StackSize >= 6'], "class": "Currency", "type": "currency very high"},
	...
	"09 Harbinger's Orb": {"base": "Harbinger's Orb", 'other': ['StackSize >= 3'], "class": "Currency", "type": "currency very high"},
	"1 Harbinger's Shard": {"base": "Harbinger's Shard", "class": "Currency", "type": "currency low"},
	"09 Harbinger's Shard": {"base": "Harbinger's Shard", 'other': ['StackSize >= 3'], "class": "Currency", "type": "currency normal"},
	"08 Harbinger's Shard": {"base": "Harbinger's Shard", 'other': ['StackSize >= 11'], "class": "Currency", "type": "currency high"},
	...
	"08 Orb of Annulment": {"base": "Orb of Annulment", 'other': ['StackSize >= 19'], "class": "Currency", "type": "currency extremely high"},
