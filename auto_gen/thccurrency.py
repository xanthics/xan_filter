#!/usr/bin/python
# -*- coding: utf-8 -*-
# Created: 09/05/2018(m/d/y) 05:08:10 UTC from "tmphardcore" data
...
items = {
	...
	"09 Ancient Shard": {"base": "Ancient Shard", 'other': ['StackSize >= 3'], "class": "Currency", "type": "currency very high"},
	...
	"08 Annulment Shard": {"base": "Annulment Shard", 'other': ['StackSize >= 10'], "class": "Currency", "type": "currency very high"},
	...
	"1 Blessing of Esh": {"base": "Blessing of Esh", "class": "Currency", "type": "currency extremely high"},
	...
	"1 Blessing of Xoph": {"base": "Blessing of Xoph", "class": "Currency", "type": "currency extremely high"},
	...
	"1 Corroded Fossil": {"base": "Corroded Fossil", "class": "Currency", "type": "currency very high"},
	...
	"08 Engineer's Orb": {"base": "Engineer's Orb", 'other': ['StackSize >= 10'], "class": "Currency", "type": "currency very high"},
	...
	"08 Engineer's Shard": {"base": "Engineer's Shard", 'other': ['StackSize >= 10'], "class": "Currency", "type": "currency normal"},
	...
	"08 Glassblower's Bauble": {"base": "Glassblower's Bauble", 'other': ['StackSize >= 18'], "class": "Currency", "type": "currency very high"},
	...
	"09 Harbinger's Orb": {"base": "Harbinger's Orb", 'other': ['StackSize >= 8'], "class": "Currency", "type": "currency extremely high"},
	"1 Harbinger's Shard": {"base": "Harbinger's Shard", "class": "Currency", "type": "currency normal"},
	"09 Harbinger's Shard": {"base": "Harbinger's Shard", 'other': ['StackSize >= 4'], "class": "Currency", "type": "currency high"},
	"08 Harbinger's Shard": {"base": "Harbinger's Shard", 'other': ['StackSize >= 16'], "class": "Currency", "type": "currency very high"},
	"1 Hollow Fossil": {"base": "Hollow Fossil", "class": "Currency", "type": "currency high"},
	"1 Horizon Shard": {"base": "Horizon Shard", "class": "Currency", "type": "currency low"},
	"09 Horizon Shard": {"base": "Horizon Shard", 'other': ['StackSize >= 2'], "class": "Currency", "type": "currency normal"},
	"08 Horizon Shard": {"base": "Horizon Shard", 'other': ['StackSize >= 7'], "class": "Currency", "type": "currency high"},
	...
	"08 Journeyman Cartographer's Sextant": {"base": "Journeyman Cartographer's Sextant", 'other': ['StackSize >= 17'], "class": "Currency", "type": "currency extremely high"},
	...
	"08 Master Cartographer's Sextant": {"base": "Master Cartographer's Sextant", 'other': ['StackSize >= 12'], "class": "Currency", "type": "currency extremely high"},
	...
	"08 Orb of Annulment": {"base": "Orb of Annulment", 'other': ['StackSize >= 15'], "class": "Currency", "type": "currency extremely high"},
	...
	"08 Orb of Binding": {"base": "Orb of Binding", 'other': ['StackSize >= 8'], "class": "Currency", "type": "currency very high"},
	...
	"09 Orb of Horizons": {"base": "Orb of Horizons", 'other': ['StackSize >= 2'], "class": "Currency", "type": "currency very high"},
	"08 Orb of Horizons": {"base": "Orb of Horizons", 'other': ['StackSize >= 17'], "class": "Currency", "type": "currency extremely high"},
	...
	"09 Orb of Transmutation": {"base": "Orb of Transmutation", 'other': ['StackSize >= 3'], "class": "Currency", "type": "currency low"},
	"08 Orb of Transmutation": {"base": "Orb of Transmutation", 'other': ['StackSize >= 9'], "class": "Currency", "type": "currency normal"},
	...
	"08 Vaal Orb": {"base": "Vaal Orb", 'other': ['StackSize >= 15'], "class": "Currency", "type": "currency very high"},
}
