...
items = {
	...
	"09 Binding Shard": {"base": "Binding Shard", 'other': ['StackSize >= 5'], "class": "Currency", "type": "currency low"},
	...
	"08 Glassblower's Bauble": {"base": "Glassblower's Bauble", 'other': ['StackSize >= 13'], "class": "Currency", "type": "currency very high"},
	...
	"08 Orb of Alchemy": {"base": "Orb of Alchemy", 'other': ['StackSize >= 16'], "class": "Currency", "type": "currency very high"},
	...
	"08 Orb of Annulment": {"base": "Orb of Annulment", 'other': ['StackSize >= 20'], "class": "Currency", "type": "currency extremely high"},
	...
	"08 Orb of Fusing": {"base": "Orb of Fusing", 'other': ['StackSize >= 20'], "class": "Currency", "type": "currency very high"},
	...
	"09 Scroll of Wisdom": {"base": "Scroll of Wisdom", 'other': ['StackSize >= 4'], "class": "Currency", "type": "currency low"},
	"08 Scroll of Wisdom": {"base": "Scroll of Wisdom", 'other': ['StackSize >= 13'], "class": "Currency", "type": "currency normal"},
	...
	"08 Splinter of Xoph": {"base": "Splinter of Xoph", 'other': ['StackSize >= 20'], "class": "Currency", "type": "currency very high"},
	...
	"08 Vaal Orb": {"base": "Vaal Orb", 'other': ['StackSize >= 12'], "class": "Currency", "type": "currency very high"},
}
