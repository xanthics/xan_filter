...
items = {
	...
	"08 Alchemy Shard": {"base": "Alchemy Shard", 'other': ['StackSize >= 3'], "class": "Currency", "type": "currency low"},
	"07 Alchemy Shard": {"base": "Alchemy Shard", 'other': ['StackSize >= 11'], "class": "Currency", "type": "currency normal"},
	"1 Alteration Shard": {"base": "Alteration Shard", "class": "Currency", "type": "hide"},
	"09 Alteration Shard": {"base": "Alteration Shard", 'other': ['StackSize >= 7'], "class": "Currency", "type": "currency very low"},
	"08 Alteration Shard": {"base": "Alteration Shard", 'other': ['StackSize >= 14'], "class": "Currency", "type": "currency low"},
	...
	"08 Ancient Shard": {"base": "Ancient Shard", 'other': ['StackSize >= 13'], "class": "Currency", "type": "currency very high"},
	...
	"07 Armourer's Scrap": {"base": "Armourer's Scrap", 'other': ['StackSize >= 9'], "class": "Currency", "type": "currency normal"},
	"1 Binding Shard": {"base": "Binding Shard", "class": "Currency", "type": "hide"},
	"09 Binding Shard": {"base": "Binding Shard", 'other': ['StackSize >= 2'], "class": "Currency", "type": "currency very low"},
	"08 Binding Shard": {"base": "Binding Shard", 'other': ['StackSize >= 3'], "class": "Currency", "type": "currency low"},
	"07 Binding Shard": {"base": "Binding Shard", 'other': ['StackSize >= 10'], "class": "Currency", "type": "currency normal"},
	...
	"08 Harbinger's Shard": {"base": "Harbinger's Shard", 'other': ['StackSize >= 17'], "class": "Currency", "type": "currency very high"},
	...
	"08 Orb of Alchemy": {"base": "Orb of Alchemy", 'other': ['StackSize >= 11'], "class": "Currency", "type": "currency very high"},
	...
	"07 Orb of Augmentation": {"base": "Orb of Augmentation", 'other': ['StackSize >= 9'], "class": "Currency", "type": "currency normal"},
