...
items = {
	...
	"09 Alchemy Shard": {"base": "Alchemy Shard", 'other': ['StackSize >= 18'], "class": "Currency", "type": "currency normal"},
	...
	"09 Ancient Orb": {"base": "Ancient Orb", 'other': ['StackSize >= 3'], "class": "Currency", "type": "currency very high"},
	"1 Ancient Shard": {"base": "Ancient Shard", "class": "Currency", "type": "currency low"},
	"09 Ancient Shard": {"base": "Ancient Shard", 'other': ['StackSize >= 2'], "class": "Currency", "type": "currency normal"},
	"08 Ancient Shard": {"base": "Ancient Shard", 'other': ['StackSize >= 6'], "class": "Currency", "type": "currency high"},
	"1 Annulment Shard": {"base": "Annulment Shard", "class": "Currency", "type": "currency high"},
	"09 Annulment Shard": {"base": "Annulment Shard", 'other': ['StackSize >= 4'], "class": "Currency", "type": "currency very high"},
	"1 Simple Sextant": {"base": "Simple Sextant", "class": "Currency", "type": "currency high"},
	"09 Simple Sextant": {"base": "Simple Sextant", 'other': ['StackSize >= 8'], "class": "Currency", "type": "currency very high"},
	...
	"09 Binding Shard": {"base": "Binding Shard", 'other': ['StackSize >= 9'], "class": "Currency", "type": "currency normal"},
	...
	"06 Blacksmith's Whetstone": {"base": "Blacksmith's Whetstone", 'other': ['StackSize >= 20'], "class": "Currency", "type": "currency high"},
	"1 Blessed Orb": {"base": "Blessed Orb", "class": "Currency", "type": "currency show"},
	"09 Blessed Orb": {"base": "Blessed Orb", 'other': ['StackSize >= 4'], "class": "Currency", "type": "currency normal"},
	"08 Blessed Orb": {"base": "Blessed Orb", 'other': ['StackSize >= 15'], "class": "Currency", "type": "currency high"},
	...
	"09 Chaos Orb": {"base": "Chaos Orb", 'other': ['StackSize >= 8'], "class": "Currency", "type": "currency very high"},
	"1 Chaos Shard": {"base": "Chaos Shard", "class": "Currency", "type": "currency show"},
	"09 Chaos Shard": {"base": "Chaos Shard", 'other': ['StackSize >= 5'], "class": "Currency", "type": "currency normal"},
	"08 Chaos Shard": {"base": "Chaos Shard", 'other': ['StackSize >= 20'], "class": "Currency", "type": "currency high"},
	...
	"08 Chromatic Orb": {"base": "Chromatic Orb", 'other': ['StackSize >= 10'], "class": "Currency", "type": "currency high"},
	...
	"09 Divine Orb": {"base": "Divine Orb", 'other': ['StackSize >= 7'], "class": "Currency", "type": "currency extremely high"},
	"1 Enchanted Fossil": {"base": "Enchanted Fossil", "class": "Currency", "type": "currency high"},
	"1 Encrusted Fossil": {"base": "Encrusted Fossil", "class": "Currency", "type": "currency normal"},
	"1 Engineer's Orb": {"base": "Engineer's Orb", "class": "Currency", "type": "currency high"},
	"09 Engineer's Orb": {"base": "Engineer's Orb", 'other': ['StackSize >= 8'], "class": "Currency", "type": "currency very high"},
	"1 Engineer's Shard": {"base": "Engineer's Shard", "class": "Currency", "type": "currency show"},
	"09 Engineer's Shard": {"base": "Engineer's Shard", 'other': ['StackSize >= 5'], "class": "Currency", "type": "currency normal"},
	"08 Engineer's Shard": {"base": "Engineer's Shard", 'other': ['StackSize >= 20'], "class": "Currency", "type": "currency high"},
	...
	"09 Harbinger's Orb": {"base": "Harbinger's Orb", 'other': ['StackSize >= 10'], "class": "Currency", "type": "currency extremely high"},
	...
	"08 Harbinger's Shard": {"base": "Harbinger's Shard", 'other': ['StackSize >= 20'], "class": "Currency", "type": "currency very high"},
	"1 Hollow Fossil": {"base": "Hollow Fossil", "class": "Currency", "type": "currency extremely high"},
	"1 Horizon Shard": {"base": "Horizon Shard", "class": "Currency", "type": "currency show"},
	"09 Horizon Shard": {"base": "Horizon Shard", 'other': ['StackSize >= 9'], "class": "Currency", "type": "currency normal"},
	...
	"1 Prime Sextant": {"base": "Prime Sextant", "class": "Currency", "type": "currency high"},
	"09 Prime Sextant": {"base": "Prime Sextant", 'other': ['StackSize >= 5'], "class": "Currency", "type": "currency very high"},
	"1 Lucent Fossil": {"base": "Lucent Fossil", "class": "Currency", "type": "currency high"},
	"1 Awakened Sextant": {"base": "Awakened Sextant", "class": "Currency", "type": "currency high"},
	"09 Awakened Sextant": {"base": "Awakened Sextant", 'other': ['StackSize >= 4'], "class": "Currency", "type": "currency very high"},
	...
	"09 Orb of Annulment": {"base": "Orb of Annulment", 'other': ['StackSize >= 5'], "class": "Currency", "type": "currency extremely high"},
	"1 Orb of Augmentation": {"base": "Orb of Augmentation", "class": "Currency", "type": "hide"},
	"09 Orb of Augmentation": {"base": "Orb of Augmentation", 'other': ['StackSize >= 2'], "class": "Currency", "type": "currency very low"},
	"08 Orb of Augmentation": {"base": "Orb of Augmentation", 'other': ['StackSize >= 4'], "class": "Currency", "type": "currency low"},
	"07 Orb of Augmentation": {"base": "Orb of Augmentation", 'other': ['StackSize >= 7'], "class": "Currency", "type": "currency normal"},
	...
	"08 Orb of Binding": {"base": "Orb of Binding", 'other': ['StackSize >= 15'], "class": "Currency", "type": "currency very high"},
	...
	"09 Orb of Regret": {"base": "Orb of Regret", 'other': ['StackSize >= 3'], "class": "Currency", "type": "currency high"},
	"08 Orb of Regret": {"base": "Orb of Regret", 'other': ['StackSize >= 19'], "class": "Currency", "type": "currency very high"},
	"1 Orb of Scouring": {"base": "Orb of Scouring", "class": "Currency", "type": "currency normal"},
	"09 Orb of Scouring": {"base": "Orb of Scouring", 'other': ['StackSize >= 4'], "class": "Currency", "type": "currency high"},
	"08 Orb of Scouring": {"base": "Orb of Scouring", 'other': ['StackSize >= 26'], "class": "Currency", "type": "currency very high"},
	...
	"07 Orb of Transmutation": {"base": "Orb of Transmutation", 'other': ['StackSize >= 5'], "class": "Currency", "type": "currency normal"},
	"06 Orb of Transmutation": {"base": "Orb of Transmutation", 'other': ['StackSize >= 20'], "class": "Currency", "type": "currency high"},
	...
	"08 Perandus Coin": {"base": "Perandus Coin", 'other': ['StackSize >= 50'], "class": "Currency", "type": "currency high"},
	"07 Perandus Coin": {"base": "Perandus Coin", 'other': ['StackSize >= 400'], "class": "Currency", "type": "currency very high"},
	"1 Perfect Fossil": {"base": "Perfect Fossil", "class": "Currency", "type": "currency very high"},
	"1 Portal Scroll": {"base": "Portal Scroll", "class": "Currency", "type": "hide"},
	"09 Portal Scroll": {"base": "Portal Scroll", 'other': ['StackSize >= 3'], "class": "Currency", "type": "currency very low"},
	"08 Portal Scroll": {"base": "Portal Scroll", 'other': ['StackSize >= 5'], "class": "Currency", "type": "currency low"},
	"07 Portal Scroll": {"base": "Portal Scroll", 'other': ['StackSize >= 9'], "class": "Currency", "type": "currency normal"},
	"06 Portal Scroll": {"base": "Portal Scroll", 'other': ['StackSize >= 34'], "class": "Currency", "type": "currency high"},
	"1 Potent Alchemical Resonator": {"base": "Potent Alchemical Resonator", "class": "Currency", "type": "currency high"},
	...
	"09 Regal Orb": {"base": "Regal Orb", 'other': ['StackSize >= 4'], "class": "Currency", "type": "currency high"},
	"1 Regal Shard": {"base": "Regal Shard", "class": "Currency", "type": "currency show"},
	"09 Regal Shard": {"base": "Regal Shard", 'other': ['StackSize >= 18'], "class": "Currency", "type": "currency normal"},
	...
	"07 Scroll of Wisdom": {"base": "Scroll of Wisdom", 'other': ['StackSize >= 13'], "class": "Currency", "type": "currency normal"},
	"1 Serrated Fossil": {"base": "Serrated Fossil", "class": "Currency", "type": "currency very high"},
	...
	"08 Silver Coin": {"base": "Silver Coin", 'other': ['StackSize >= 8'], "class": "Currency", "type": "currency high"},
	...
	"08 Splinter of Chayula": {"base": "Splinter of Chayula", 'other': ['StackSize >= 10'], "class": "Currency", "type": "currency very high"},
	...
	"08 Splinter of Esh": {"base": "Splinter of Esh", 'other': ['StackSize >= 6'], "class": "Currency", "type": "currency high"},
	"07 Splinter of Esh": {"base": "Splinter of Esh", 'other': ['StackSize >= 48'], "class": "Currency", "type": "currency very high"},
	...
	"08 Splinter of Tul": {"base": "Splinter of Tul", 'other': ['StackSize >= 9'], "class": "Currency", "type": "currency high"},
	"07 Splinter of Tul": {"base": "Splinter of Tul", 'other': ['StackSize >= 67'], "class": "Currency", "type": "currency very high"},
	...
	"08 Splinter of Uul-Netol": {"base": "Splinter of Uul-Netol", 'other': ['StackSize >= 29'], "class": "Currency", "type": "currency very high"},
	...
	"07 Splinter of Xoph": {"base": "Splinter of Xoph", 'other': ['StackSize >= 40'], "class": "Currency", "type": "currency very high"},
	"1 Tangled Fossil": {"base": "Tangled Fossil", "class": "Currency", "type": "currency high"},
	...
	"09 Vaal Orb": {"base": "Vaal Orb", 'other': ['StackSize >= 4'], "class": "Currency", "type": "currency high"},
