...
items = {
	...
	"09 Alteration Shard": {"base": "Alteration Shard", 'other': ['StackSize >= 12'], "class": "Currency", "type": "currency low"},
	...
	"08 Ancient Shard": {"base": "Ancient Shard", 'other': ['StackSize >= 15'], "class": "Currency", "type": "currency very high"},
	...
	"08 Chromatic Orb": {"base": "Chromatic Orb", 'other': ['StackSize >= 9'], "class": "Currency", "type": "currency high"},
	...
	"09 Engineer's Orb": {"base": "Engineer's Orb", 'other': ['StackSize >= 4'], "class": "Currency", "type": "currency very high"},
	...
	"07 Horizon Shard": {"base": "Horizon Shard", 'other': ['StackSize >= 19'], "class": "Currency", "type": "currency high"},
	...
	"08 Orb of Alteration": {"base": "Orb of Alteration", 'other': ['StackSize >= 9'], "class": "Currency", "type": "currency high"},
	...
	"08 Orb of Binding": {"base": "Orb of Binding", 'other': ['StackSize >= 17'], "class": "Currency", "type": "currency very high"},
	...
	"09 Orb of Horizons": {"base": "Orb of Horizons", 'other': ['StackSize >= 10'], "class": "Currency", "type": "currency very high"},
	...
	"08 Regal Shard": {"base": "Regal Shard", 'other': ['StackSize >= 6'], "class": "Currency", "type": "currency normal"},
	...
	"09 Splinter of Tul": {"base": "Splinter of Tul", 'other': ['StackSize >= 5'], "class": "Currency", "type": "currency normal"},
