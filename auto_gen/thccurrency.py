...
items = {
	...
	"08 Ancient Shard": {"base": "Ancient Shard", 'other': ['StackSize >= 10'], "class": "Currency", "type": "currency very high"},
	...
	"09 Transmutation Shard": {"base": "Transmutation Shard", 'other': ['StackSize >= 14'], "class": "Currency", "type": "currency very low"},
