#!/usr/bin/python
# -*- coding: utf-8 -*-
# Created: 12/08/2018(m/d/y) 17:35:55 UTC from "tmphardcore" data
...
items = {
	...
	"09 Blacksmith's Whetstone": {"base": "Blacksmith's Whetstone", 'other': ['StackSize >= 4'], "class": "Currency", "type": "currency normal"},
	"08 Blacksmith's Whetstone": {"base": "Blacksmith's Whetstone", 'other': ['StackSize >= 13'], "class": "Currency", "type": "currency high"},
	...
	"08 Blessed Orb": {"base": "Blessed Orb", 'other': ['StackSize >= 7'], "class": "Currency", "type": "currency high"},
	...
	"08 Divine Orb": {"base": "Divine Orb", 'other': ['StackSize >= 11'], "class": "Currency", "type": "currency extremely high"},
	...
	"08 Glassblower's Bauble": {"base": "Glassblower's Bauble", 'other': ['StackSize >= 13'], "class": "Currency", "type": "currency high"},
	...
	"08 Jeweller's Orb": {"base": "Jeweller's Orb", 'other': ['StackSize >= 5'], "class": "Currency", "type": "currency normal"},
	"07 Jeweller's Orb": {"base": "Jeweller's Orb", 'other': ['StackSize >= 17'], "class": "Currency", "type": "currency high"},
	...
	"07 Orb of Augmentation": {"base": "Orb of Augmentation", 'other': ['StackSize >= 17'], "class": "Currency", "type": "currency high"},
	...
	"08 Orb of Scouring": {"base": "Orb of Scouring", 'other': ['StackSize >= 19'], "class": "Currency", "type": "currency very high"},
	"1 Orb of Transmutation": {"base": "Orb of Transmutation", "class": "Currency", "type": "currency normal"},
	"09 Orb of Transmutation": {"base": "Orb of Transmutation", 'other': ['StackSize >= 3'], "class": "Currency", "type": "currency high"},
	"08 Orb of Transmutation": {"base": "Orb of Transmutation", 'other': ['StackSize >= 15'], "class": "Currency", "type": "currency very high"},
	...
	"09 Transmutation Shard": {"base": "Transmutation Shard", 'other': ['StackSize >= 4'], "class": "Currency", "type": "currency low"},
	"08 Transmutation Shard": {"base": "Transmutation Shard", 'other': ['StackSize >= 15'], "class": "Currency", "type": "currency normal"},
	...
	"08 Vaal Orb": {"base": "Vaal Orb", 'other': ['StackSize >= 9'], "class": "Currency", "type": "currency very high"},
}
