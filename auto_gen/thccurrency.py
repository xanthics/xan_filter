...
items = {
	...
	"08 Ancient Orb": {"base": "Ancient Orb", 'other': ['StackSize >= 17'], "class": "Currency", "type": "currency extremely high"},
	...
	"08 Ancient Shard": {"base": "Ancient Shard", 'other': ['StackSize >= 5'], "class": "Currency", "type": "currency high"},
	...
	"09 Blessed Orb": {"base": "Blessed Orb", 'other': ['StackSize >= 3'], "class": "Currency", "type": "currency normal"},
	"08 Blessed Orb": {"base": "Blessed Orb", 'other': ['StackSize >= 12'], "class": "Currency", "type": "currency high"},
	...
	"09 Engineer's Orb": {"base": "Engineer's Orb", 'other': ['StackSize >= 7'], "class": "Currency", "type": "currency very high"},
	...
	"1 Fractured Fossil": {"base": "Fractured Fossil", "class": "Currency", "type": "currency very high"},
	...
	"08 Glassblower's Bauble": {"base": "Glassblower's Bauble", 'other': ['StackSize >= 20'], "class": "Currency", "type": "currency very high"},
	...
	"08 Harbinger's Shard": {"base": "Harbinger's Shard", 'other': ['StackSize >= 19'], "class": "Currency", "type": "currency very high"},
	...
	"08 Orb of Binding": {"base": "Orb of Binding", 'other': ['StackSize >= 12'], "class": "Currency", "type": "currency very high"},
	...
	"08 Orb of Regret": {"base": "Orb of Regret", 'other': ['StackSize >= 16'], "class": "Currency", "type": "currency very high"},
	...
	"08 Orb of Scouring": {"base": "Orb of Scouring", 'other': ['StackSize >= 22'], "class": "Currency", "type": "currency very high"},
	...
	"07 Perandus Coin": {"base": "Perandus Coin", 'other': ['StackSize >= 350'], "class": "Currency", "type": "currency very high"},
	...
	"09 Regal Shard": {"base": "Regal Shard", 'other': ['StackSize >= 15'], "class": "Currency", "type": "currency normal"},
	...
	"08 Splinter of Chayula": {"base": "Splinter of Chayula", 'other': ['StackSize >= 9'], "class": "Currency", "type": "currency very high"},
	"07 Splinter of Chayula": {"base": "Splinter of Chayula", 'other': ['StackSize >= 88'], "class": "Currency", "type": "currency extremely high"},
	...
	"07 Splinter of Esh": {"base": "Splinter of Esh", 'other': ['StackSize >= 35'], "class": "Currency", "type": "currency very high"},
	...
	"07 Splinter of Tul": {"base": "Splinter of Tul", 'other': ['StackSize >= 39'], "class": "Currency", "type": "currency very high"},
	...
	"07 Splinter of Uul-Netol": {"base": "Splinter of Uul-Netol", 'other': ['StackSize >= 37'], "class": "Currency", "type": "currency very high"},
	...
	"08 Splinter of Xoph": {"base": "Splinter of Xoph", 'other': ['StackSize >= 7'], "class": "Currency", "type": "currency high"},
	"07 Splinter of Xoph": {"base": "Splinter of Xoph", 'other': ['StackSize >= 47'], "class": "Currency", "type": "currency very high"},
