...
items = {
	...
	"1 Esh's Charged Breachstone": {"base": "Esh's Charged Breachstone", "class": "Map Fragments", "type": "map yellow good"},
	"1 Esh's Enriched Breachstone": {"base": "Esh's Enriched Breachstone", "class": "Map Fragments", "type": "map yellow good"},
	"1 Esh's Pure Breachstone": {"base": "Esh's Pure Breachstone", "class": "Map Fragments", "type": "map very good"},
	"1 Fragment of the Chimera": {"base": "Fragment of the Chimera", "class": "Map Fragments", "type": "map yellow good"},
	"1 Fragment of the Hydra": {"base": "Fragment of the Hydra", "class": "Map Fragments", "type": "map yellow good"},
	"1 Fragment of the Minotaur": {"base": "Fragment of the Minotaur", "class": "Map Fragments", "type": "map yellow good"},
	"1 Fragment of the Phoenix": {"base": "Fragment of the Phoenix", "class": "Map Fragments", "type": "map yellow good"},
	"1 Inya's Key": {"base": "Inya's Key", "class": "Map Fragments", "type": "map yellow good"},
	"1 Mortal Grief": {"base": "Mortal Grief", "class": "Map Fragments", "type": "map white good"},
	...
	"1 Sacrifice at Dusk": {"base": "Sacrifice at Dusk", "class": "Map Fragments", "type": "map white good"},
	...
	"1 Tul's Breachstone": {"base": "Tul's Breachstone", "class": "Map Fragments", "type": "map yellow good"},
	"1 Tul's Charged Breachstone": {"base": "Tul's Charged Breachstone", "class": "Map Fragments", "type": "map yellow good"},
	"1 Tul's Enriched Breachstone": {"base": "Tul's Enriched Breachstone", "class": "Map Fragments", "type": "map yellow good"},
	"1 Tul's Pure Breachstone": {"base": "Tul's Pure Breachstone", "class": "Map Fragments", "type": "map very good"},
	"1 Uul-Netol's Breachstone": {"base": "Uul-Netol's Breachstone", "class": "Map Fragments", "type": "map yellow good"},
	...
	"1 Uul-Netol's Pure Breachstone": {"base": "Uul-Netol's Pure Breachstone", "class": "Map Fragments", "type": "map very good"},
	"1 Volkuur's Key": {"base": "Volkuur's Key", "class": "Map Fragments", "type": "map yellow good"},
	"1 Xoph's Breachstone": {"base": "Xoph's Breachstone", "class": "Map Fragments", "type": "map yellow good"},
	"1 Xoph's Charged Breachstone": {"base": "Xoph's Charged Breachstone", "class": "Map Fragments", "type": "map yellow good"},
	"1 Xoph's Enriched Breachstone": {"base": "Xoph's Enriched Breachstone", "class": "Map Fragments", "type": "map yellow good"},
	"1 Xoph's Pure Breachstone": {"base": "Xoph's Pure Breachstone", "class": "Map Fragments", "type": "map very good"},
