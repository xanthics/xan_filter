...
items = {
	...
	"09 Ancient Shard": {"base": "Ancient Shard", 'other': ['StackSize >= 15'], "class": "Currency", "type": "currency very high"},
	...
	"09 Harbinger's Shard": {"base": "Harbinger's Shard", 'other': ['StackSize >= 15'], "class": "Currency", "type": "currency very high"},
	...
	"09 Orb of Augmentation": {"base": "Orb of Augmentation", 'other': ['StackSize >= 13'], "class": "Currency", "type": "currency normal"},
	...
	"08 Orb of Horizons": {"base": "Orb of Horizons", 'other': ['StackSize >= 20'], "class": "Currency", "type": "currency very high"},
	...
	"09 Splinter of Chayula": {"base": "Splinter of Chayula", 'other': ['StackSize >= 12'], "class": "Currency", "type": "currency very high"},
