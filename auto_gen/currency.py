#!/usr/bin/python
# -*- coding: utf-8 -*-
# Created: 06/09/2019(m/d/y) 20:45:10 UTC from "Standard" data
...
items = {
	...
	"09 Alchemy Shard": {"base": "Alchemy Shard", 'other': ['StackSize >= 16'], "class": "Currency", "type": "currency normal"},
	...
	"09 Apprentice Cartographer's Sextant": {"base": "Apprentice Cartographer's Sextant", 'other': ['StackSize >= 14'], "class": "Currency", "type": "currency very high"},
	"1 Armourer's Scrap": {"base": "Armourer's Scrap", "class": "Currency", "type": "currency very low"},
	"09 Armourer's Scrap": {"base": "Armourer's Scrap", 'other': ['StackSize >= 13'], "class": "Currency", "type": "currency low"},
	...
	"09 Blacksmith's Whetstone": {"base": "Blacksmith's Whetstone", 'other': ['StackSize >= 13'], "class": "Currency", "type": "currency low"},
	...
	"09 Engineer's Shard": {"base": "Engineer's Shard", 'other': ['StackSize >= 13'], "class": "Currency", "type": "currency normal"},
	...
	"09 Harbinger's Shard": {"base": "Harbinger's Shard", 'other': ['StackSize >= 14'], "class": "Currency", "type": "currency very high"},
	...
	"09 Orb of Regret": {"base": "Orb of Regret", 'other': ['StackSize >= 15'], "class": "Currency", "type": "currency very high"},
	...
	"09 Portal Scroll": {"base": "Portal Scroll", 'other': ['StackSize >= 13'], "class": "Currency", "type": "currency low"},
