...
items = {
	...
	"09 Ancient Shard": {"base": "Ancient Shard", 'other': ['StackSize >= 12'], "class": "Currency", "type": "currency very high"},
	...
	"09 Armourer's Scrap": {"base": "Armourer's Scrap", 'other': ['StackSize >= 7'], "class": "Currency", "type": "currency very low"},
	"08 Armourer's Scrap": {"base": "Armourer's Scrap", 'other': ['StackSize >= 13'], "class": "Currency", "type": "currency low"},
	"07 Armourer's Scrap": {"base": "Armourer's Scrap", 'other': ['StackSize >= 25'], "class": "Currency", "type": "currency normal"},
	"1 Binding Shard": {"base": "Binding Shard", "class": "Currency", "type": "currency show"},
	"09 Binding Shard": {"base": "Binding Shard", 'other': ['StackSize >= 20'], "class": "Currency", "type": "currency normal"},
	"1 Blacksmith's Whetstone": {"base": "Blacksmith's Whetstone", "class": "Currency", "type": "hide"},
	"09 Blacksmith's Whetstone": {"base": "Blacksmith's Whetstone", 'other': ['StackSize >= 7'], "class": "Currency", "type": "currency very low"},
	"08 Blacksmith's Whetstone": {"base": "Blacksmith's Whetstone", 'other': ['StackSize >= 13'], "class": "Currency", "type": "currency low"},
	...
	"08 Chromatic Orb": {"base": "Chromatic Orb", 'other': ['StackSize >= 5'], "class": "Currency", "type": "currency high"},
	...
	"08 Glassblower's Bauble": {"base": "Glassblower's Bauble", 'other': ['StackSize >= 9'], "class": "Currency", "type": "currency high"},
	...
	"09 Harbinger's Shard": {"base": "Harbinger's Shard", 'other': ['StackSize >= 13'], "class": "Currency", "type": "currency very high"},
	...
	"08 Horizon Shard": {"base": "Horizon Shard", 'other': ['StackSize >= 20'], "class": "Currency", "type": "currency high"},
	...
	"08 Jeweller's Orb": {"base": "Jeweller's Orb", 'other': ['StackSize >= 6'], "class": "Currency", "type": "currency high"},
	...
	"09 Orb of Horizons": {"base": "Orb of Horizons", 'other': ['StackSize >= 15'], "class": "Currency", "type": "currency very high"},
	"1 Orb of Regret": {"base": "Orb of Regret", "class": "Currency", "type": "currency high"},
	"09 Orb of Regret": {"base": "Orb of Regret", 'other': ['StackSize >= 9'], "class": "Currency", "type": "currency very high"},
	...
	"09 Orb of Transmutation": {"base": "Orb of Transmutation", 'other': ['StackSize >= 7'], "class": "Currency", "type": "currency very low"},
	"08 Orb of Transmutation": {"base": "Orb of Transmutation", 'other': ['StackSize >= 13'], "class": "Currency", "type": "currency low"},
	"07 Orb of Transmutation": {"base": "Orb of Transmutation", 'other': ['StackSize >= 25'], "class": "Currency", "type": "currency normal"},
	"1 Perandus Coin": {"base": "Perandus Coin", "class": "Currency", "type": "currency show"},
	"09 Perandus Coin": {"base": "Perandus Coin", 'other': ['StackSize >= 25'], "class": "Currency", "type": "currency normal"},
	"08 Perandus Coin": {"base": "Perandus Coin", 'other': ['StackSize >= 100'], "class": "Currency", "type": "currency high"},
	...
	"07 Portal Scroll": {"base": "Portal Scroll", 'other': ['StackSize >= 25'], "class": "Currency", "type": "currency normal"},
	...
	"08 Splinter of Chayula": {"base": "Splinter of Chayula", 'other': ['StackSize >= 91'], "class": "Currency", "type": "currency extremely high"},
	...
	"07 Splinter of Uul-Netol": {"base": "Splinter of Uul-Netol", 'other': ['StackSize >= 84'], "class": "Currency", "type": "currency very high"},
