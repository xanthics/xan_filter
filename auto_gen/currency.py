...
items = {
	...
	"08 Binding Shard": {"base": "Binding Shard", 'other': ['StackSize >= 19'], "class": "Currency", "type": "currency normal"},
	...
	"09 Orb of Regret": {"base": "Orb of Regret", 'other': ['StackSize >= 11'], "class": "Currency", "type": "currency very high"},
