...
items = {
	...
	"09 Ancient Shard": {"base": "Ancient Shard", 'other': ['StackSize >= 13'], "class": "Currency", "type": "currency very high"},
	...
	"08 Binding Shard": {"base": "Binding Shard", 'other': ['StackSize >= 18'], "class": "Currency", "type": "currency normal"},
