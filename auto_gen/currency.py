...
items = {
	...
	"09 Cartographer's Chisel": {"base": "Cartographer's Chisel", 'other': ['StackSize >= 2'], "class": "Currency", "type": "currency high"},
	...
	"09 Engineer's Shard": {"base": "Engineer's Shard", 'other': ['StackSize >= 8'], "class": "Currency", "type": "currency normal"},
	...
	"08 Horizon Shard": {"base": "Horizon Shard", 'other': ['StackSize >= 19'], "class": "Currency", "type": "currency high"},
	...
	"08 Orb of Alteration": {"base": "Orb of Alteration", 'other': ['StackSize >= 5'], "class": "Currency", "type": "currency high"},
	...
	"06 Orb of Augmentation": {"base": "Orb of Augmentation", 'other': ['StackSize >= 17'], "class": "Currency", "type": "currency high"},
	...
	"08 Orb of Chance": {"base": "Orb of Chance", 'other': ['StackSize >= 6'], "class": "Currency", "type": "currency high"},
	...
	"09 Orb of Horizons": {"base": "Orb of Horizons", 'other': ['StackSize >= 14'], "class": "Currency", "type": "currency very high"},
	...
	"1 Primitive Alchemical Resonator": {"base": "Primitive Alchemical Resonator", "class": "Currency", "type": "currency low"},
	...
	"09 Regal Shard": {"base": "Regal Shard", 'other': ['StackSize >= 7'], "class": "Currency", "type": "currency normal"},
	...
	"08 Splinter of Chayula": {"base": "Splinter of Chayula", 'other': ['StackSize >= 97'], "class": "Currency", "type": "currency extremely high"},
	...
	"07 Splinter of Uul-Netol": {"base": "Splinter of Uul-Netol", 'other': ['StackSize >= 69'], "class": "Currency", "type": "currency very high"},
	...
	"07 Splinter of Xoph": {"base": "Splinter of Xoph", 'other': ['StackSize >= 66'], "class": "Currency", "type": "currency very high"},
