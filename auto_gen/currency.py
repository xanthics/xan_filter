...
items = {
	...
	"07 Alchemy Shard": {"base": "Alchemy Shard", 'other': ['StackSize >= 17'], "class": "Currency", "type": "currency normal"},
	...
	"1 Dense Fossil": {"base": "Dense Fossil", "class": "Currency", "type": "currency extremely high"},
	...
	"07 Engineer's Shard": {"base": "Engineer's Shard", 'other': ['StackSize >= 17'], "class": "Currency", "type": "currency normal"},
	...
	"1 Potent Alchemical Resonator": {"base": "Potent Alchemical Resonator", "class": "Currency", "type": "currency very high"},
	...
	"08 Splinter of Uul-Netol": {"base": "Splinter of Uul-Netol", 'other': ['StackSize >= 4'], "class": "Currency", "type": "currency high"},
