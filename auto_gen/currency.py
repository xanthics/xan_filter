...
items = {
	...
	"09 Alchemy Shard": {"base": "Alchemy Shard", 'other': ['StackSize >= 12'], "class": "Currency", "type": "currency normal"},
	...
	"09 Binding Shard": {"base": "Binding Shard", 'other': ['StackSize >= 5'], "class": "Currency", "type": "currency very low"},
	"08 Binding Shard": {"base": "Binding Shard", 'other': ['StackSize >= 10'], "class": "Currency", "type": "currency low"},
	...
	"08 Blacksmith's Whetstone": {"base": "Blacksmith's Whetstone", 'other': ['StackSize >= 5'], "class": "Currency", "type": "currency low"},
	"07 Blacksmith's Whetstone": {"base": "Blacksmith's Whetstone", 'other': ['StackSize >= 9'], "class": "Currency", "type": "currency normal"},
	...
	"07 Engineer's Shard": {"base": "Engineer's Shard", 'other': ['StackSize >= 5'], "class": "Currency", "type": "currency normal"},
	"06 Engineer's Shard": {"base": "Engineer's Shard", 'other': ['StackSize >= 20'], "class": "Currency", "type": "currency high"},
	...
	"08 Horizon Shard": {"base": "Horizon Shard", 'other': ['StackSize >= 17'], "class": "Currency", "type": "currency high"},
	...
	"09 Orb of Augmentation": {"base": "Orb of Augmentation", 'other': ['StackSize >= 3'], "class": "Currency", "type": "currency very low"},
	"08 Orb of Augmentation": {"base": "Orb of Augmentation", 'other': ['StackSize >= 5'], "class": "Currency", "type": "currency low"},
	...
	"09 Orb of Horizons": {"base": "Orb of Horizons", 'other': ['StackSize >= 13'], "class": "Currency", "type": "currency very high"},
	"1 Orb of Regret": {"base": "Orb of Regret", "class": "Currency", "type": "currency high"},
	"09 Orb of Regret": {"base": "Orb of Regret", 'other': ['StackSize >= 10'], "class": "Currency", "type": "currency very high"},
	"1 Orb of Scouring": {"base": "Orb of Scouring", "class": "Currency", "type": "currency high"},
	"09 Orb of Scouring": {"base": "Orb of Scouring", 'other': ['StackSize >= 15'], "class": "Currency", "type": "currency very high"},
	...
	"1 Potent Alchemical Resonator": {"base": "Potent Alchemical Resonator", "class": "Currency", "type": "currency low"},
	...
	"08 Regal Orb": {"base": "Regal Orb", 'other': ['StackSize >= 19'], "class": "Currency", "type": "currency very high"},
	...
	"09 Silver Coin": {"base": "Silver Coin", 'other': ['StackSize >= 3'], "class": "Currency", "type": "currency high"},
