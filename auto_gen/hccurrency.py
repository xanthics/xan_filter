...
items = {
	...
	"09 Alteration Shard": {"base": "Alteration Shard", 'other': ['StackSize >= 12'], "class": "Currency", "type": "currency very low"},
	...
	"08 Apprentice Cartographer's Sextant": {"base": "Apprentice Cartographer's Sextant", 'other': ['StackSize >= 18'], "class": "Currency", "type": "currency extremely high"},
	...
	"09 Orb of Alteration": {"base": "Orb of Alteration", 'other': ['StackSize >= 5'], "class": "Currency", "type": "currency normal"},
	...
	"07 Orb of Augmentation": {"base": "Orb of Augmentation", 'other': ['StackSize >= 13'], "class": "Currency", "type": "currency normal"},
	"1 Orb of Binding": {"base": "Orb of Binding", "class": "Currency", "type": "currency high"},
	"09 Orb of Binding": {"base": "Orb of Binding", 'other': ['StackSize >= 8'], "class": "Currency", "type": "currency very high"},
	...
	"09 Orb of Regret": {"base": "Orb of Regret", 'other': ['StackSize >= 8'], "class": "Currency", "type": "currency very high"},
	...
	"08 Regal Shard": {"base": "Regal Shard", 'other': ['StackSize >= 12'], "class": "Currency", "type": "currency high"},
	...
	"08 Splinter of Chayula": {"base": "Splinter of Chayula", 'other': ['StackSize >= 15'], "class": "Currency", "type": "currency extremely high"},
	"1 Splinter of Esh": {"base": "Splinter of Esh", "class": "Currency", "type": "currency high"},
	"09 Splinter of Esh": {"base": "Splinter of Esh", 'other': ['StackSize >= 8'], "class": "Currency", "type": "currency very high"},
	"1 Splinter of Tul": {"base": "Splinter of Tul", "class": "Currency", "type": "currency high"},
	"09 Splinter of Tul": {"base": "Splinter of Tul", 'other': ['StackSize >= 8'], "class": "Currency", "type": "currency very high"},
	...
	"09 Splinter of Xoph": {"base": "Splinter of Xoph", 'other': ['StackSize >= 8'], "class": "Currency", "type": "currency very high"},
