...
items = {
	...
	"08 Annulment Shard": {"base": "Annulment Shard", 'other': ['StackSize >= 16'], "class": "Currency", "type": "currency very high"},
	"1 Apprentice Cartographer's Sextant": {"base": "Apprentice Cartographer's Sextant", "class": "Currency", "type": "currency high"},
	"09 Apprentice Cartographer's Sextant": {"base": "Apprentice Cartographer's Sextant", 'other': ['StackSize >= 2'], "class": "Currency", "type": "currency very high"},
	"1 Armourer's Scrap": {"base": "Armourer's Scrap", "class": "Currency", "type": "currency very low"},
	"09 Armourer's Scrap": {"base": "Armourer's Scrap", 'other': ['StackSize >= 4'], "class": "Currency", "type": "currency low"},
	"08 Armourer's Scrap": {"base": "Armourer's Scrap", 'other': ['StackSize >= 13'], "class": "Currency", "type": "currency normal"},
	...
	"08 Binding Shard": {"base": "Binding Shard", 'other': ['StackSize >= 20'], "class": "Currency", "type": "currency normal"},
	...
	"09 Blessed Orb": {"base": "Blessed Orb", 'other': ['StackSize >= 6'], "class": "Currency", "type": "currency very high"},
	...
	"1 Blessing of Uul-Netol": {"base": "Blessing of Uul-Netol", "class": "Currency", "type": "currency extremely high"},
	...
	"08 Engineer's Orb": {"base": "Engineer's Orb", 'other': ['StackSize >= 16'], "class": "Currency", "type": "currency very high"},
	...
	"1 Horizon Shard": {"base": "Horizon Shard", "class": "Currency", "type": "currency normal"},
	"09 Horizon Shard": {"base": "Horizon Shard", 'other': ['StackSize >= 2'], "class": "Currency", "type": "currency high"},
	"08 Horizon Shard": {"base": "Horizon Shard", 'other': ['StackSize >= 15'], "class": "Currency", "type": "currency very high"},
	...
	"08 Journeyman Cartographer's Sextant": {"base": "Journeyman Cartographer's Sextant", 'other': ['StackSize >= 16'], "class": "Currency", "type": "currency extremely high"},
	...
	"08 Orb of Chance": {"base": "Orb of Chance", 'other': ['StackSize >= 7'], "class": "Currency", "type": "currency high"},
	...
	"09 Orb of Horizons": {"base": "Orb of Horizons", 'other': ['StackSize >= 9'], "class": "Currency", "type": "currency extremely high"},
	"1 Orb of Regret": {"base": "Orb of Regret", "class": "Currency", "type": "currency high"},
	"09 Orb of Regret": {"base": "Orb of Regret", 'other': ['StackSize >= 6'], "class": "Currency", "type": "currency very high"},
	...
	"08 Regal Shard": {"base": "Regal Shard", 'other': ['StackSize >= 13'], "class": "Currency", "type": "currency high"},
	...
	"09 Splinter of Chayula": {"base": "Splinter of Chayula", 'other': ['StackSize >= 2'], "class": "Currency", "type": "currency very high"},
	"08 Splinter of Chayula": {"base": "Splinter of Chayula", 'other': ['StackSize >= 18'], "class": "Currency", "type": "currency extremely high"},
	"1 Splinter of Esh": {"base": "Splinter of Esh", "class": "Currency", "type": "currency high"},
	"09 Splinter of Esh": {"base": "Splinter of Esh", 'other': ['StackSize >= 3'], "class": "Currency", "type": "currency very high"},
	"1 Splinter of Tul": {"base": "Splinter of Tul", "class": "Currency", "type": "currency high"},
	"09 Splinter of Tul": {"base": "Splinter of Tul", 'other': ['StackSize >= 3'], "class": "Currency", "type": "currency very high"},
	"1 Splinter of Uul-Netol": {"base": "Splinter of Uul-Netol", "class": "Currency", "type": "currency high"},
	"09 Splinter of Uul-Netol": {"base": "Splinter of Uul-Netol", 'other': ['StackSize >= 2'], "class": "Currency", "type": "currency very high"},
	"1 Splinter of Xoph": {"base": "Splinter of Xoph", "class": "Currency", "type": "currency normal"},
	"09 Splinter of Xoph": {"base": "Splinter of Xoph", 'other': ['StackSize >= 2'], "class": "Currency", "type": "currency high"},
	"08 Splinter of Xoph": {"base": "Splinter of Xoph", 'other': ['StackSize >= 11'], "class": "Currency", "type": "currency very high"},
