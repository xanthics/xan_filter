...
items = {
	...
	"09 Alteration Shard": {"base": "Alteration Shard", 'other': ['StackSize >= 8'], "class": "Currency", "type": "currency very low"},
	"08 Alteration Shard": {"base": "Alteration Shard", 'other': ['StackSize >= 15'], "class": "Currency", "type": "currency low"},
	...
	"09 Scroll of Wisdom": {"base": "Scroll of Wisdom", 'other': ['StackSize >= 2'], "class": "Currency", "type": "currency very low"},
	"08 Scroll of Wisdom": {"base": "Scroll of Wisdom", 'other': ['StackSize >= 4'], "class": "Currency", "type": "currency low"},
	...
	"09 Transmutation Shard": {"base": "Transmutation Shard", 'other': ['StackSize >= 7'], "class": "Currency", "type": "currency very low"},
	"08 Transmutation Shard": {"base": "Transmutation Shard", 'other': ['StackSize >= 13'], "class": "Currency", "type": "currency low"},
