...
items = {
	...
	"09 Alteration Shard": {"base": "Alteration Shard", 'other': ['StackSize >= 14'], "class": "Currency", "type": "currency very low"},
	...
	"09 Annulment Shard": {"base": "Annulment Shard", 'other': ['StackSize >= 3'], "class": "Currency", "type": "currency high"},
	"08 Annulment Shard": {"base": "Annulment Shard", 'other': ['StackSize >= 15'], "class": "Currency", "type": "currency very high"},
	...
	"08 Blessed Orb": {"base": "Blessed Orb", 'other': ['StackSize >= 11'], "class": "Currency", "type": "currency very high"},
	...
	"08 Cartographer's Chisel": {"base": "Cartographer's Chisel", 'other': ['StackSize >= 7'], "class": "Currency", "type": "currency high"},
	"1 Chaos Orb": {"base": "Chaos Orb", "class": "Currency", "type": "currency normal"},
	"09 Chaos Orb": {"base": "Chaos Orb", 'other': ['StackSize >= 2'], "class": "Currency", "type": "currency high"},
	"08 Chaos Orb": {"base": "Chaos Orb", 'other': ['StackSize >= 8'], "class": "Currency", "type": "currency very high"},
	...
	"08 Engineer's Orb": {"base": "Engineer's Orb", 'other': ['StackSize >= 15'], "class": "Currency", "type": "currency very high"},
	...
	"08 Harbinger's Orb": {"base": "Harbinger's Orb", 'other': ['StackSize >= 19'], "class": "Currency", "type": "currency extremely high"},
	...
	"08 Harbinger's Shard": {"base": "Harbinger's Shard", 'other': ['StackSize >= 6'], "class": "Currency", "type": "currency high"},
	...
	"08 Orb of Alchemy": {"base": "Orb of Alchemy", 'other': ['StackSize >= 6'], "class": "Currency", "type": "currency high"},
	"1 Orb of Alteration": {"base": "Orb of Alteration", "class": "Currency", "type": "currency show"},
	"09 Orb of Alteration": {"base": "Orb of Alteration", 'other': ['StackSize >= 6'], "class": "Currency", "type": "currency normal"},
	...
	"09 Orb of Binding": {"base": "Orb of Binding", 'other': ['StackSize >= 5'], "class": "Currency", "type": "currency high"},
	...
	"1 Pristine Fossil": {"base": "Pristine Fossil", "class": "Currency", "type": "currency normal"},
	...
	"08 Regal Shard": {"base": "Regal Shard", 'other': ['StackSize >= 14'], "class": "Currency", "type": "currency high"},
	...
	"08 Silver Coin": {"base": "Silver Coin", 'other': ['StackSize >= 9'], "class": "Currency", "type": "currency high"},
	...
	"09 Splinter of Uul-Netol": {"base": "Splinter of Uul-Netol", 'other': ['StackSize >= 3'], "class": "Currency", "type": "currency high"},
	"08 Splinter of Uul-Netol": {"base": "Splinter of Uul-Netol", 'other': ['StackSize >= 15'], "class": "Currency", "type": "currency very high"},
	...
	"09 Vaal Orb": {"base": "Vaal Orb", 'other': ['StackSize >= 7'], "class": "Currency", "type": "currency very high"},
}
