...
items = {
	...
	"09 Alchemy Shard": {"base": "Alchemy Shard", 'other': ['StackSize >= 14'], "class": "Currency", "type": "currency normal"},
	...
	"09 Blacksmith's Whetstone": {"base": "Blacksmith's Whetstone", 'other': ['StackSize >= 4'], "class": "Currency", "type": "currency very low"},
	"08 Blacksmith's Whetstone": {"base": "Blacksmith's Whetstone", 'other': ['StackSize >= 7'], "class": "Currency", "type": "currency low"},
	"07 Blacksmith's Whetstone": {"base": "Blacksmith's Whetstone", 'other': ['StackSize >= 13'], "class": "Currency", "type": "currency normal"},
	...
	"08 Blessed Orb": {"base": "Blessed Orb", 'other': ['StackSize >= 8'], "class": "Currency", "type": "currency high"},
	...
	"08 Cartographer's Chisel": {"base": "Cartographer's Chisel", 'other': ['StackSize >= 15'], "class": "Currency", "type": "currency very high"},
	...
	"1 Corroded Fossil": {"base": "Corroded Fossil", "class": "Currency", "type": "currency normal"},
	...
	"1 Enchanted Fossil": {"base": "Enchanted Fossil", "class": "Currency", "type": "currency very high"},
	"1 Encrusted Fossil": {"base": "Encrusted Fossil", "class": "Currency", "type": "currency high"},
	"1 Engineer's Orb": {"base": "Engineer's Orb", "class": "Currency", "type": "currency show"},
	"09 Engineer's Orb": {"base": "Engineer's Orb", 'other': ['StackSize >= 2'], "class": "Currency", "type": "currency normal"},
	"08 Engineer's Orb": {"base": "Engineer's Orb", 'other': ['StackSize >= 5'], "class": "Currency", "type": "currency high"},
	...
	"09 Exalted Shard": {"base": "Exalted Shard", 'other': ['StackSize >= 12'], "class": "Currency", "type": "currency extremely high"},
	...
	"09 Glassblower's Bauble": {"base": "Glassblower's Bauble", 'other': ['StackSize >= 4'], "class": "Currency", "type": "currency normal"},
	"08 Glassblower's Bauble": {"base": "Glassblower's Bauble", 'other': ['StackSize >= 15'], "class": "Currency", "type": "currency high"},
	...
	"08 Harbinger's Shard": {"base": "Harbinger's Shard", 'other': ['StackSize >= 8'], "class": "Currency", "type": "currency very high"},
	...
	"09 Horizon Shard": {"base": "Horizon Shard", 'other': ['StackSize >= 7'], "class": "Currency", "type": "currency normal"},
	"1 Jagged Fossil": {"base": "Jagged Fossil", "class": "Currency", "type": "currency normal"},
	...
	"07 Jeweller's Orb": {"base": "Jeweller's Orb", 'other': ['StackSize >= 12'], "class": "Currency", "type": "currency high"},
	...
	"09 Orb of Annulment": {"base": "Orb of Annulment", 'other': ['StackSize >= 2'], "class": "Currency", "type": "currency extremely high"},
	...
	"08 Orb of Augmentation": {"base": "Orb of Augmentation", 'other': ['StackSize >= 4'], "class": "Currency", "type": "currency normal"},
	"07 Orb of Augmentation": {"base": "Orb of Augmentation", 'other': ['StackSize >= 15'], "class": "Currency", "type": "currency high"},
	...
	"08 Orb of Horizons": {"base": "Orb of Horizons", 'other': ['StackSize >= 9'], "class": "Currency", "type": "currency very high"},
	...
	"08 Orb of Scouring": {"base": "Orb of Scouring", 'other': ['StackSize >= 8'], "class": "Currency", "type": "currency very high"},
	"1 Orb of Transmutation": {"base": "Orb of Transmutation", "class": "Currency", "type": "hide"},
	"09 Orb of Transmutation": {"base": "Orb of Transmutation", 'other': ['StackSize >= 4'], "class": "Currency", "type": "currency very low"},
	"08 Orb of Transmutation": {"base": "Orb of Transmutation", 'other': ['StackSize >= 7'], "class": "Currency", "type": "currency low"},
	...
	"09 Perandus Coin": {"base": "Perandus Coin", 'other': ['StackSize >= 5'], "class": "Currency", "type": "currency normal"},
	"08 Perandus Coin": {"base": "Perandus Coin", 'other': ['StackSize >= 17'], "class": "Currency", "type": "currency high"},
	"07 Perandus Coin": {"base": "Perandus Coin", 'other': ['StackSize >= 117'], "class": "Currency", "type": "currency very high"},
	...
	"1 Powerful Alchemical Resonator": {"base": "Powerful Alchemical Resonator", "class": "Currency", "type": "currency low"},
	...
	"08 Regal Orb": {"base": "Regal Orb", 'other': ['StackSize >= 8'], "class": "Currency", "type": "currency very high"},
	"1 Regal Shard": {"base": "Regal Shard", "class": "Currency", "type": "currency show"},
	"09 Regal Shard": {"base": "Regal Shard", 'other': ['StackSize >= 6'], "class": "Currency", "type": "currency normal"},
	...
	"09 Scroll of Wisdom": {"base": "Scroll of Wisdom", 'other': ['StackSize >= 7'], "class": "Currency", "type": "currency very low"},
	"08 Scroll of Wisdom": {"base": "Scroll of Wisdom", 'other': ['StackSize >= 13'], "class": "Currency", "type": "currency low"},
	"07 Scroll of Wisdom": {"base": "Scroll of Wisdom", 'other': ['StackSize >= 25'], "class": "Currency", "type": "currency normal"},
	...
	"07 Silver Coin": {"base": "Silver Coin", 'other': ['StackSize >= 30'], "class": "Currency", "type": "currency very high"},
	...
	"08 Splinter of Chayula": {"base": "Splinter of Chayula", 'other': ['StackSize >= 50'], "class": "Currency", "type": "currency extremely high"},
	...
	"07 Splinter of Esh": {"base": "Splinter of Esh", 'other': ['StackSize >= 70'], "class": "Currency", "type": "currency very high"},
	...
	"07 Splinter of Tul": {"base": "Splinter of Tul", 'other': ['StackSize >= 59'], "class": "Currency", "type": "currency very high"},
	...
	"07 Splinter of Uul-Netol": {"base": "Splinter of Uul-Netol", 'other': ['StackSize >= 54'], "class": "Currency", "type": "currency very high"},
	...
	"08 Splinter of Xoph": {"base": "Splinter of Xoph", 'other': ['StackSize >= 10'], "class": "Currency", "type": "currency high"},
	"07 Splinter of Xoph": {"base": "Splinter of Xoph", 'other': ['StackSize >= 64'], "class": "Currency", "type": "currency very high"},
