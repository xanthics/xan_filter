...
items = {
	...
	"09 Alchemy Shard": {"base": "Alchemy Shard", 'other': ['StackSize >= 8'], "class": "Currency", "type": "currency low"},
	...
	"09 Orb of Augmentation": {"base": "Orb of Augmentation", 'other': ['StackSize >= 4'], "class": "Currency", "type": "currency low"},
	"08 Orb of Augmentation": {"base": "Orb of Augmentation", 'other': ['StackSize >= 13'], "class": "Currency", "type": "currency normal"},
