...
items = {
	...
	"08 Harbinger's Shard": {"base": "Harbinger's Shard", 'other': ['StackSize >= 14'], "class": "Currency", "type": "currency very high"},
	...
	"09 Prime Sextant": {"base": "Prime Sextant", 'other': ['StackSize >= 6'], "class": "Currency", "type": "currency very high"},
	...
	"09 Awakened Sextant": {"base": "Awakened Sextant", 'other': ['StackSize >= 5'], "class": "Currency", "type": "currency very high"},
	...
	"08 Orb of Horizons": {"base": "Orb of Horizons", 'other': ['StackSize >= 15'], "class": "Currency", "type": "currency very high"},
	...
	"08 Orb of Regret": {"base": "Orb of Regret", 'other': ['StackSize >= 17'], "class": "Currency", "type": "currency very high"},
	...
	"08 Orb of Scouring": {"base": "Orb of Scouring", 'other': ['StackSize >= 13'], "class": "Currency", "type": "currency very high"},
	...
	"07 Perandus Coin": {"base": "Perandus Coin", 'other': ['StackSize >= 200'], "class": "Currency", "type": "currency very high"},
	...
	"08 Splinter of Chayula": {"base": "Splinter of Chayula", 'other': ['StackSize >= 78'], "class": "Currency", "type": "currency extremely high"},
	...
	"07 Splinter of Uul-Netol": {"base": "Splinter of Uul-Netol", 'other': ['StackSize >= 93'], "class": "Currency", "type": "currency very high"},
