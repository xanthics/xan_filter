...
items = {
	...
	"07 Alchemy Shard": {"base": "Alchemy Shard", 'other': ['StackSize >= 19'], "class": "Currency", "type": "currency normal"},
	...
	"08 Journeyman Cartographer's Sextant": {"base": "Journeyman Cartographer's Sextant", 'other': ['StackSize >= 15'], "class": "Currency", "type": "currency extremely high"},
