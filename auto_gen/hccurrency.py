...
items = {
	...
	"09 Regal Orb": {"base": "Regal Orb", 'other': ['StackSize >= 3'], "class": "Currency", "type": "currency very high"},
	"1 Regal Shard": {"base": "Regal Shard", "class": "Currency", "type": "currency low"},
	"09 Regal Shard": {"base": "Regal Shard", 'other': ['StackSize >= 2'], "class": "Currency", "type": "currency normal"},
	"08 Regal Shard": {"base": "Regal Shard", 'other': ['StackSize >= 7'], "class": "Currency", "type": "currency high"},
