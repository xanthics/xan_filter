...
items = {
	...
	"08 Ancient Orb": {"base": "Ancient Orb", 'other': ['StackSize >= 14'], "class": "Currency", "type": "currency extremely high"},
	...
	"08 Annulment Shard": {"base": "Annulment Shard", 'other': ['StackSize >= 18'], "class": "Currency", "type": "currency very high"},
	"1 Apprentice Cartographer's Sextant": {"base": "Apprentice Cartographer's Sextant", "class": "Currency", "type": "currency high"},
	"09 Apprentice Cartographer's Sextant": {"base": "Apprentice Cartographer's Sextant", 'other': ['StackSize >= 3'], "class": "Currency", "type": "currency very high"},
	...
	"08 Engineer's Orb": {"base": "Engineer's Orb", 'other': ['StackSize >= 18'], "class": "Currency", "type": "currency very high"},
	...
	"09 Exalted Shard": {"base": "Exalted Shard", 'other': ['StackSize >= 4'], "class": "Currency", "type": "currency very high"},
	...
	"09 Harbinger's Shard": {"base": "Harbinger's Shard", 'other': ['StackSize >= 5'], "class": "Currency", "type": "currency very high"},
	...
	"08 Horizon Shard": {"base": "Horizon Shard", 'other': ['StackSize >= 18'], "class": "Currency", "type": "currency very high"},
	...
	"09 Master Cartographer's Sextant": {"base": "Master Cartographer's Sextant", 'other': ['StackSize >= 7'], "class": "Currency", "type": "currency extremely high"},
	...
	"09 Orb of Augmentation": {"base": "Orb of Augmentation", 'other': ['StackSize >= 3'], "class": "Currency", "type": "currency normal"},
	"08 Orb of Augmentation": {"base": "Orb of Augmentation", 'other': ['StackSize >= 10'], "class": "Currency", "type": "currency high"},
	...
	"08 Orb of Binding": {"base": "Orb of Binding", 'other': ['StackSize >= 18'], "class": "Currency", "type": "currency very high"},
	...
	"08 Orb of Transmutation": {"base": "Orb of Transmutation", 'other': ['StackSize >= 10'], "class": "Currency", "type": "currency high"},
	...
	"09 Regal Shard": {"base": "Regal Shard", 'other': ['StackSize >= 3'], "class": "Currency", "type": "currency normal"},
	"08 Regal Shard": {"base": "Regal Shard", 'other': ['StackSize >= 10'], "class": "Currency", "type": "currency high"},
	...
	"1 Splinter of Xoph": {"base": "Splinter of Xoph", "class": "Currency", "type": "currency high"},
	"09 Splinter of Xoph": {"base": "Splinter of Xoph", 'other': ['StackSize >= 3'], "class": "Currency", "type": "currency very high"},
	...
	"09 Transmutation Shard": {"base": "Transmutation Shard", 'other': ['StackSize >= 13'], "class": "Currency", "type": "currency low"},
