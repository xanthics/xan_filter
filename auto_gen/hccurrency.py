...
items = {
	...
	"09 Alteration Shard": {"base": "Alteration Shard", 'other': ['StackSize >= 11'], "class": "Currency", "type": "currency very low"},
	...
	"08 Orb of Alteration": {"base": "Orb of Alteration", 'other': ['StackSize >= 4'], "class": "Currency", "type": "currency normal"},
	"07 Orb of Alteration": {"base": "Orb of Alteration", 'other': ['StackSize >= 16'], "class": "Currency", "type": "currency high"},
	...
	"07 Orb of Augmentation": {"base": "Orb of Augmentation", 'other': ['StackSize >= 8'], "class": "Currency", "type": "currency normal"},
	...
	"08 Orb of Transmutation": {"base": "Orb of Transmutation", 'other': ['StackSize >= 5'], "class": "Currency", "type": "currency low"},
	"07 Orb of Transmutation": {"base": "Orb of Transmutation", 'other': ['StackSize >= 16'], "class": "Currency", "type": "currency normal"},
