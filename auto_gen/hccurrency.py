...
items = {
	...
	"08 Alchemy Shard": {"base": "Alchemy Shard", 'other': ['StackSize >= 7'], "class": "Currency", "type": "currency low"},
	"1 Alteration Shard": {"base": "Alteration Shard", "class": "Currency", "type": "hide"},
	"09 Alteration Shard": {"base": "Alteration Shard", 'other': ['StackSize >= 10'], "class": "Currency", "type": "currency very low"},
	"08 Alteration Shard": {"base": "Alteration Shard", 'other': ['StackSize >= 20'], "class": "Currency", "type": "currency low"},
	...
	"09 Harbinger's Orb": {"base": "Harbinger's Orb", 'other': ['StackSize >= 2'], "class": "Currency", "type": "currency extremely high"},
	"1 Harbinger's Shard": {"base": "Harbinger's Shard", "class": "Currency", "type": "currency high"},
	"09 Harbinger's Shard": {"base": "Harbinger's Shard", 'other': ['StackSize >= 4'], "class": "Currency", "type": "currency very high"},
