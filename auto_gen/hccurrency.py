...
items = {
	...
	"0 Engineer's Orb": {"base": "Engineer's Orb", "class": "Currency", "type": "currency extremely high"},
	"0 Engineer's Shard": {"base": "Engineer's Shard", "class": "Currency", "type": "currency very high"},
