...
items = {
	...
	"09 Alchemy Shard": {"base": "Alchemy Shard", 'other': ['StackSize >= 20'], "class": "Currency", "type": "currency normal"},
	...
	"08 Apprentice Cartographer's Sextant": {"base": "Apprentice Cartographer's Sextant", 'other': ['StackSize >= 11'], "class": "Currency", "type": "currency very high"},
	"1 Armourer's Scrap": {"base": "Armourer's Scrap", "class": "Currency", "type": "currency very low"},
	"09 Armourer's Scrap": {"base": "Armourer's Scrap", 'other': ['StackSize >= 5'], "class": "Currency", "type": "currency low"},
	"08 Armourer's Scrap": {"base": "Armourer's Scrap", 'other': ['StackSize >= 10'], "class": "Currency", "type": "currency normal"},
	...
	"09 Blacksmith's Whetstone": {"base": "Blacksmith's Whetstone", 'other': ['StackSize >= 5'], "class": "Currency", "type": "currency low"},
	"08 Blacksmith's Whetstone": {"base": "Blacksmith's Whetstone", 'other': ['StackSize >= 10'], "class": "Currency", "type": "currency normal"},
	...
	"09 Chaos Orb": {"base": "Chaos Orb", 'other': ['StackSize >= 10'], "class": "Currency", "type": "currency very high"},
	...
	"08 Chromatic Orb": {"base": "Chromatic Orb", 'other': ['StackSize >= 13'], "class": "Currency", "type": "currency high"},
	...
	"09 Divine Orb": {"base": "Divine Orb", 'other': ['StackSize >= 3'], "class": "Currency", "type": "currency extremely high"},
	...
	"09 Engineer's Orb": {"base": "Engineer's Orb", 'other': ['StackSize >= 5'], "class": "Currency", "type": "currency high"},
	"1 Engineer's Shard": {"base": "Engineer's Shard", "class": "Currency", "type": "currency show"},
	"09 Engineer's Shard": {"base": "Engineer's Shard", 'other': ['StackSize >= 18'], "class": "Currency", "type": "currency normal"},
	...
	"08 Exalted Shard": {"base": "Exalted Shard", 'other': ['StackSize >= 16'], "class": "Currency", "type": "currency extremely high"},
	...
	"09 Orb of Chance": {"base": "Orb of Chance", 'other': ['StackSize >= 5'], "class": "Currency", "type": "currency high"},
	...
	"08 Orb of Regret": {"base": "Orb of Regret", 'other': ['StackSize >= 15'], "class": "Currency", "type": "currency very high"},
	...
	"09 Orb of Transmutation": {"base": "Orb of Transmutation", 'other': ['StackSize >= 10'], "class": "Currency", "type": "currency normal"},
	"1 Perandus Coin": {"base": "Perandus Coin", "class": "Currency", "type": "currency show"},
	"09 Perandus Coin": {"base": "Perandus Coin", 'other': ['StackSize >= 4'], "class": "Currency", "type": "currency normal"},
	...
	"09 Portal Scroll": {"base": "Portal Scroll", 'other': ['StackSize >= 5'], "class": "Currency", "type": "currency low"},
	"08 Portal Scroll": {"base": "Portal Scroll", 'other': ['StackSize >= 10'], "class": "Currency", "type": "currency normal"},
	...
	"1 Primitive Alchemical Resonator": {"base": "Primitive Alchemical Resonator", "class": "Currency", "type": "currency high"},
	...
	"08 Regal Orb": {"base": "Regal Orb", 'other': ['StackSize >= 12'], "class": "Currency", "type": "currency very high"},
	"1 Regal Shard": {"base": "Regal Shard", "class": "Currency", "type": "currency show"},
	"09 Regal Shard": {"base": "Regal Shard", 'other': ['StackSize >= 5'], "class": "Currency", "type": "currency normal"},
	...
	"09 Scroll of Wisdom": {"base": "Scroll of Wisdom", 'other': ['StackSize >= 10'], "class": "Currency", "type": "currency low"},
	"08 Scroll of Wisdom": {"base": "Scroll of Wisdom", 'other': ['StackSize >= 20'], "class": "Currency", "type": "currency normal"},
	...
	"09 Splinter of Chayula": {"base": "Splinter of Chayula", 'other': ['StackSize >= 7'], "class": "Currency", "type": "currency very high"},
	...
	"09 Vaal Orb": {"base": "Vaal Orb", 'other': ['StackSize >= 8'], "class": "Currency", "type": "currency very high"},
