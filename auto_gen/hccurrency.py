...
items = {
	...
	"1 Orb of Chance": {"base": "Orb of Chance", "class": "Currency", "type": "currency high"},
	"09 Orb of Chance": {"base": "Orb of Chance", 'other': ['StackSize >= 2'], "class": "Currency", "type": "currency very high"},
