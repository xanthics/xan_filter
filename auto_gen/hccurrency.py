...
items = {
	...
	"09 Harbinger's Shard": {"base": "Harbinger's Shard", 'other': ['StackSize >= 7'], "class": "Currency", "type": "currency very high"},
	...
	"08 Orb of Fusing": {"base": "Orb of Fusing", 'other': ['StackSize >= 12'], "class": "Currency", "type": "currency very high"},
