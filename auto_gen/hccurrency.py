...
items = {
	...
	"08 Ancient Orb": {"base": "Ancient Orb", 'other': ['StackSize >= 15'], "class": "Currency", "type": "currency extremely high"},
	...
	"08 Regal Shard": {"base": "Regal Shard", 'other': ['StackSize >= 11'], "class": "Currency", "type": "currency high"},
	...
	"09 Transmutation Shard": {"base": "Transmutation Shard", 'other': ['StackSize >= 17'], "class": "Currency", "type": "currency very low"},
