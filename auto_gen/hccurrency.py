...
items = {
	...
	"1 Jeweller's Orb": {"base": "Jeweller's Orb", "class": "Currency", "type": "currency high"},
	"09 Jeweller's Orb": {"base": "Jeweller's Orb", 'other': ['StackSize >= 8'], "class": "Currency", "type": "currency very high"},
	...
	"09 Orb of Scouring": {"base": "Orb of Scouring", 'other': ['StackSize >= 7'], "class": "Currency", "type": "currency very high"},
	...
	"09 Splinter of Xoph": {"base": "Splinter of Xoph", 'other': ['StackSize >= 2'], "class": "Currency", "type": "currency very high"},
	"08 Splinter of Xoph": {"base": "Splinter of Xoph", 'other': ['StackSize >= 17'], "class": "Currency", "type": "currency extremely high"},
