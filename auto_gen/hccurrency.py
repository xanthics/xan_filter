...
items = {
	...
	"08 Engineer's Orb": {"base": "Engineer's Orb", 'other': ['StackSize >= 13'], "class": "Currency", "type": "currency very high"},
	...
	"08 Exalted Shard": {"base": "Exalted Shard", 'other': ['StackSize >= 15'], "class": "Currency", "type": "currency extremely high"},
