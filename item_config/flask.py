...
items = {
    ...
    "02 Qual Flask": {"base": "Flask", "other": ["Quality >= 10"], "type": "normal border"},
    "03 Qual Flask": {"base": "Flask", "other": ["Quality >= 1", "ItemLevel <= 78"], "type": "ignore"},
    "1 Diamond Flask": {"base": "Diamond Flask", "other": ["Rarity Normal", "ItemLevel <= 78"], "type": "normal"},
    "1 Granite Flask": {"base": "Granite Flask", "other": ["Rarity Normal", "ItemLevel <= 78"], "type": "ignore"},
    "1 Jade Flask": {"base": "Jade Flask", "other": ["Rarity Normal", "ItemLevel <= 78"], "type": "normal"},
    "1 Topaz Flask": {"base": "Topaz Flask", "other": ["Rarity Normal", "ItemLevel <= 78"], "type": "normal"},
    "1 Sapphire Flask": {"base": "Sapphire Flask", "other": ["Rarity Normal", "ItemLevel <= 78"], "type": "normal"},
    "1 Ruby Flask": {"base": "Ruby Flask", "other": ["Rarity Normal", "ItemLevel <= 78"], "type": "normal"},
    "11 Quicksilver Flask <= 25": {"base": "Quicksilver Flask", "other": ["ItemLevel <= 25"], "type": "normal"},
    "12 Quicksilver Flask": {"base": "Quicksilver Flask", "other": ["Rarity Normal", "ItemLevel <= 78"], "type": "normal"},
    "1 Amethyst Flask": {"base": "Amethyst Flask", "other": ["Rarity Normal", "ItemLevel <= 78"], "type": "normal"},
    "1 Basalt Flask": {"base": "Basalt Flask", "other": ["Rarity Normal", "ItemLevel <= 78"], "type": "normal"},
    "1 Aquamarine Flask": {"base": "Aquamarine Flask", "other": ["Rarity Normal", "ItemLevel <= 78"], "type": "ignore"},
    "1 Stibnite Flask": {"base": "Stibnite Flask", "other": ["Rarity Normal", "ItemLevel <= 78"], "type": "normal"},
    "1 Sulphur Flask": {"base": "Sulphur Flask", "other": ["Rarity Normal", "ItemLevel <= 78"], "type": "ignore"},
    "1 Silver Flask": {"base": "Silver Flask", "other": ["Rarity Normal", "ItemLevel <= 78"], "type": "normal"},
    "1 Quartz Flask": {"base": "Quartz Flask", "other": ["Rarity Normal", "ItemLevel <= 78"], "type": "normal"},
    "1 Bismuth Flask": {"base": "Bismuth Flask", "other": ["Rarity Normal", "ItemLevel <= 78"], "type": "ignore"},
