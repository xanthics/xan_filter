...
items = {
	...
	"04 Steel Ring": {"other": ['CustomAlertSound "45_show.wav"'], "base": "Steel Ring", "type": "show high"},
	...
	"04 Opal Ring": {"other": ['CustomAlertSound "45_show.wav"'], "base": "Opal Ring", "type": "show high"},
