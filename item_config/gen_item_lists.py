...
bases = {
	...
	"Armour": {
		...
		"Armour|Body Armour|Dex|Int|Str": [
			{'drop': 72, 'base': 'Body Armour', 'name': 'Sacrificial Garb', 'tier': 2},
		],
		"Armour|Boots|Str": [
		...
		"Armour|Boots|Dex|Int|Str": [
			{'drop': 24, 'base': 'Boots', 'name': 'Runic Greaves', 'tier': 0},  # Ward
			{'drop': 48, 'base': 'Boots', 'name': 'Runic Sollerets', 'tier': 0},  # Ward
			{'drop': 69, 'base': 'Boots', 'name': 'Runic Sabatons', 'tier': 0},  # Ward
		...
		"Armour|Gloves|Dex|Int|Str": [
			{'drop': 24, 'base': 'Gloves', 'name': 'Runic Gloves', 'tier': 0},  # Ward
			{'drop': 48, 'base': 'Gloves', 'name': 'Runic Gages', 'tier': 0},  # Ward
			{'drop': 69, 'base': 'Gloves', 'name': 'Runic Gauntlets', 'tier': 0},  # Ward
		],
		"Armour|Helmet|Str": [
		...
		"Armour|Helmet|Dex|Int|Str": [
			{'drop': 25, 'base': 'Helmet', 'name': 'Runic Helm', 'tier': 0},  # Ward
			{'drop': 49, 'base': 'Helmet', 'name': 'Runic Crest', 'tier': 0},  # Ward
			{'drop': 68, 'base': 'Helmet', 'name': 'Runic Crown', 'tier': 0},  # Ward
		],
		"Armour|Shield|Str": [
	...
	"Accessory": {
		"Accessory|Amulet": [
			...
			{'drop': 1, 'base': 'Amulet', 'name': 'Wereclaw Talisman', 'tier': 1},  # Base Critical Strike Multiplier +(24 to 36)
			{'drop': 1, 'base': 'Amulet', 'name': 'Splitnewt Talisman', 'tier': 4},  # Chance To Freeze Shock Ignite (4 to 6)
			{'drop': 1, 'base': 'Amulet', 'name': 'Clutching Talisman', 'tier': 4},  # Global Defences +(15 to 25)
			{'drop': 1, 'base': 'Amulet', 'name': 'Avian Twins Talisman', 'tier': 2},  # Fire Damage Taken (50) As Cold or Fire Damage Taken (50) As Lightning or Cold Damage Taken (50) As Fire or Cold Damage Taken (50) As Lightning or Lightning Damage Taken (50) As Cold or Lightning Damage Taken (50) As Fire
			{'drop': 1, 'base': 'Amulet', 'name': 'Fangjaw Talisman', 'tier': 2},  # Maximum Life +(8 to 12)
			{'drop': 1, 'base': 'Amulet', 'name': 'Horned Talisman', 'tier': 3},  # Projectile Base Number Of Targets To Pierce (2)
			{'drop': 1, 'base': 'Amulet', 'name': 'Spinefuse Talisman', 'tier': 0},  # Increased Item Quantity (6 to 10)
			{'drop': 1, 'base': 'Amulet', 'name': 'Three Rat Talisman', 'tier': 3},  # All Attributes +(12 to 16)
			{'drop': 1, 'base': 'Amulet', 'name': 'Monkey Twins Talisman', 'tier': 4},  # Base Skill Area Of Effect +(5 to 8)
			{'drop': 1, 'base': 'Amulet', 'name': 'Longtooth Talisman', 'tier': 4},  # Base Additional Physical Damage Reduction (4 to 6)
			{'drop': 1, 'base': 'Amulet', 'name': 'Rotfeather Talisman', 'tier': 2},  # All Damage (25 to 35)
			{'drop': 1, 'base': 'Amulet', 'name': 'Monkey Paw Talisman', 'tier': 4},  # Add Power Charge On Kill (10) Chance or Add Frenzy Charge On Kill (10) Chance or Endurance Charge On Kill (10)
			{'drop': 1, 'base': 'Amulet', 'name': 'Three Hands Talisman', 'tier': 3},  # Physical Damage (6 to 12) To Add As Random Element
			{'drop': 1, 'base': 'Amulet', 'name': 'Jet Amulet', 'tier': 0},  # Resist all Elements (8 to 12)
			{'drop': 1, 'base': 'Amulet', 'name': 'Black Maw Talisman', 'tier': 3},  # Local Has X Sockets (1)
			{'drop': 1, 'base': 'Amulet', 'name': 'Bonespire Talisman', 'tier': 4},  # Maximum Mana +(20 to 30)
			{'drop': 1, 'base': 'Amulet', 'name': 'Ashscale Talisman', 'tier': 3},  # Fire Damage +(20 to 30)
			{'drop': 1, 'base': 'Amulet', 'name': 'Lone Antler Talisman', 'tier': 3},  # Lightning Damage +(20 to 30)
			{'drop': 1, 'base': 'Amulet', 'name': 'Deep One Talisman', 'tier': 3},  # Cold Damage +(20 to 30)
			{'drop': 1, 'base': 'Amulet', 'name': 'Breakrib Talisman', 'tier': 3},  # Physical Damage +(20 to 30)
			{'drop': 1, 'base': 'Amulet', 'name': 'Deadhand Talisman', 'tier': 3},  # Chaos Damage +(19 to 31)
			{'drop': 1, 'base': 'Amulet', 'name': 'Undying Flesh Talisman', 'tier': 4},
			{'drop': 1, 'base': 'Amulet', 'name': 'Rot Head Talisman', 'tier': 4},  # Fishing Bite Sensitivity +(30 to 40)
			...
			{'drop': 35, 'base': 'Amulet', 'name': 'Writhing Talisman', 'tier': 2},  # Attack Damage +(20 to 30)
		...
		"Accessory|Belt": [
			...
			{'drop': 12, 'base': 'Belt', 'name': 'Golden Obi', 'tier': 0},  # Base Item Found Rarity +(20 to 30)
		...
		"Accessory|Ring": [
			...
			{'drop': 15, 'base': 'Ring', 'name': 'Jet Ring', 'tier': 0},  # Global Defences +(5 to 10)
		...
		"Other": [
			...
			{'drop': 100, 'base': 'Abyss Jewel', 'name': 'Ghastly Eye Jewel', 'tier': 0},
		]
	},
}
...
def genrareshighlighttiered():
	# helper function to find highlighting tier
	def minhl(val, st):
		for sv in sorted(st):
			if val <= sv:
				return st[sv]
			...
			for i in range(len(bases[category][vals])):
				...
				for typ in type_penalty:
					...
					for c, tier in enumerate(base_mod_tiers[cur['base']]):
						...
						if typ == 'Fractured':
							ret[idx]['other'].append('FracturedItem True')
						elif typ == 'Synthesis':
							ret[idx]['other'].append('SynthesisedItem True')
						elif typ:
